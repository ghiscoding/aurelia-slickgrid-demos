# <a href="https://aurelia.io/" rel="nofollow"><img alt="Aurelia" src="https://ghiscoding.github.io/aurelia-slickgrid-demos/assets/aurelia-logo-9YSzF-gF.png" width="70"></a> Aurelia-Slickgrid - Client Demos
...
| [@slickgrid-universal/aurelia-row-detail-plugin](https://github.com/ghiscoding/slickgrid-universal/tree/master/frameworks-plugins/aurelia-row-detail-plugin) | [![npm](https://img.shields.io/npm/v/@slickgrid-universal/aurelia-row-detail-plugin.svg?color=forest)](https://www.npmjs.com/package/@slickgrid-universal/aurelia-row-detail-plugin) | Aurelia-Slickgrid Row Detail plugin |
