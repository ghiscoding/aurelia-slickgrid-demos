...
export class Example11 {
  ...
  <ul>
    ...
    <ul>
      ...
      <li>Take a look at the available <a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/blob/master/aurelia-slickgrid/src/aurelia-slickgrid/styles/_variables.scss" target="_blank">SASS Variables</a></li>
    </ul>
  </ul>
  `;
