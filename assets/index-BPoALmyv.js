import{f as be,v as ao,b as O,c as T,C as E,r as M,a as bv,A as fv,R as vv,I as _v,d as yv,p as Sv,F as f,e as Vr,n as _e,g as ye,h as Se,E as C,i as v,S as ne,j as et,k as G,G as ro,l as Ft,m as no,T as $a,o as B,q as k,s as ni,P as Di,t as Cv,u as oo,w as Vd,x as lo,y as oi,z as Ma,B as so,D as Pa,H as wv,J as Ia,K as xv,L as Tv,M as Ev,N as Ls,O as $v,Q as kv,U as D,V as dt,W as Ov,X as Dv,Y as Mv,Z as it,_ as Pv}from"./vendor-TblhxcLN.js";import"./index-BPoALmyv.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const Iv="All Selected",Gv="All {{x}} records selected",Fv="Apply Mass Update",Av="Update Selection",Rv="Cancel",Lv="Clear all Filters",zv="Clear all Grouping",Nv="Clear all Sorting",Wv="Unfreeze Columns/Rows",Bv="Clone",jv="Collapse all Groups",Vv="Columns",Hv="Resize by Content",Uv="Commands",qv="Contains",Yv="Copy",Kv="No data to display.",Qv="Ends With",Zv="Equals",Jv="Equal to",Xv="Expand all Groups",e_="Export in CSV format",t_="Export to Excel",i_="Export to PDF",a_="Export in Text format (Tab delimited)",r_="Export in Text format",n_="Filter Shortcuts",o_="{{from}}-{{to}} of {{totalItems}} items",l_="Force fit columns",s_="Freeze Columns",d_="The number must be valid and have a maximum of {{maxDecimal}} decimals.",c_="Greater than",u_="Greater than or equal to",m_="Group by",p_="Hide Column",h_="Search items in a collection, must be separated by a comma (a,b)",g_="items",b_="items per page",f_="items selected",v_="No elements found",__="Last Update",y_="Less than",S_="Less than or equal to",C_="Loading...",w_="Not contains",x_="Not equal to",T_="Search items not in a collection, must be separated by a comma (a,b)",E_="of",$_="OK",k_="Page",O_="page {{x}} of {{y}}",D_="Refresh Dataset",M_="Remove Filter",P_="Remove Sort",I_="Reset Input Value",G_="Reset Form",F_="Save",A_="Select All",R_="Sort Ascending",L_="Sort Descending",z_="Starts With",N_="Synchronous resize",W_="Toggle Filter Row",B_="Toggle Pre-Header Row",j_="Unfreeze Columns",V_="# of % selected",H_="{{x}} of {{y}} selected",U_={ADDRESS:{STREET:"Billing Address Street",ZIP:"Billing Address Zip"},INFORMATION:"Billing Information"},q_="Blank Values",Y_="Non-Blank Values",K_="Custom Commands",Q_="Duration",Z_="Company",J_="Completed",X_="Change Completed Flag",ey="Change Priority",ty="Customer Information",iy="Delete Row",ay="Disabled Command",ry="False",ny="Female",oy="Finish",ly="Future",sy="Gender",dy="Help",cy="High",uy="Low",my="Medium",py="Male",hy="Name",gy="Next 20 days",by="None",fy="Past",vy="% Complete",_y="Priority",yy="Start",Sy="Task {{x}}",Cy="Title",wy="Today",xy="True",Ty="{{x}} day{{plural}}",Ey="Update the current row",$y="Cancel changes of the current row",ky={ALL_SELECTED:Iv,ALL_X_RECORDS_SELECTED:Gv,APPLY_MASS_UPDATE:Fv,APPLY_TO_SELECTION:Av,CANCEL:Rv,CLEAR_ALL_FILTERS:Lv,CLEAR_ALL_GROUPING:zv,CLEAR_ALL_SORTING:Nv,CLEAR_PINNING:Wv,CLONE:Bv,COLLAPSE_ALL_GROUPS:jv,COLUMNS:Vv,COLUMN_RESIZE_BY_CONTENT:Hv,COMMANDS:Uv,CONTAINS:qv,COPY:Yv,EMPTY_DATA_WARNING_MESSAGE:Kv,ENDS_WITH:Qv,EQUALS:Zv,EQUAL_TO:Jv,EXPAND_ALL_GROUPS:Xv,EXPORT_TO_CSV:e_,EXPORT_TO_EXCEL:t_,EXPORT_TO_PDF:i_,EXPORT_TO_TAB_DELIMITED:a_,EXPORT_TO_TEXT_FORMAT:r_,FILTER_SHORTCUTS:n_,FROM_TO_OF_TOTAL_ITEMS:o_,FORCE_FIT_COLUMNS:l_,FREEZE_COLUMNS:s_,INVALID_FLOAT:d_,GREATER_THAN:c_,GREATER_THAN_OR_EQUAL_TO:u_,GROUP_BY:m_,HIDE_COLUMN:p_,IN_COLLECTION_SEPERATED_BY_COMMA:h_,ITEMS:g_,ITEMS_PER_PAGE:b_,ITEMS_SELECTED:f_,NO_ELEMENTS_FOUND:v_,LAST_UPDATE:__,LESS_THAN:y_,LESS_THAN_OR_EQUAL_TO:S_,LOADING:C_,NOT_CONTAINS:w_,NOT_EQUAL_TO:x_,NOT_IN_COLLECTION_SEPERATED_BY_COMMA:T_,OF:E_,OK:$_,PAGE:k_,PAGE_X_OF_Y:O_,REFRESH_DATASET:D_,REMOVE_FILTER:M_,REMOVE_SORT:P_,RESET_INPUT_VALUE:I_,RESET_FORM:G_,SAVE:F_,SELECT_ALL:A_,SORT_ASCENDING:R_,SORT_DESCENDING:L_,STARTS_WITH:z_,SYNCHRONOUS_RESIZE:N_,TOGGLE_FILTER_ROW:W_,TOGGLE_PRE_HEADER_ROW:B_,UNFREEZE_COLUMNS:j_,X_OF_Y_SELECTED:V_,X_OF_Y_MASS_SELECTED:H_,BILLING:U_,BLANK_VALUES:q_,NON_BLANK_VALUES:Y_,CUSTOM_COMMANDS:K_,DURATION:Q_,COMPANY:Z_,COMPLETED:J_,CHANGE_COMPLETED_FLAG:X_,CHANGE_PRIORITY:ey,CUSTOMER_INFORMATION:ty,DELETE_ROW:iy,DISABLED_COMMAND:ay,FALSE:ry,FEMALE:ny,FINISH:oy,FUTURE:ly,GENDER:sy,HELP:dy,HIGH:cy,LOW:uy,MEDIUM:my,MALE:py,NAME:hy,NEXT_20_DAYS:gy,NONE:by,PAST:fy,PERCENT_COMPLETE:vy,PRIORITY:_y,START:yy,TASK_X:Sy,TITLE:Cy,TODAY:wy,TRUE:xy,X_DAY_PLURAL:Ty,RBE_BTN_UPDATE:Ey,RBE_BTN_CANCEL:$y},Oy="Tout sélectionnés",Dy="Sur tous les {{x}} éléments",My="Mettre à jour en masse",Py="Mettre à jour la sélection",Iy="Annuler",Gy="Supprimer tous les filtres",Fy="Supprimer tous les groupes",Ay="Supprimer tous les tris",Ry="Dégeler les colonnes/rangées",Ly="Cloner",zy="Réduire tous les groupes",Ny="Colonnes",Wy="Redimensionner par contenu",By="Commandes",jy="Contient",Vy="Copier",Hy="Aucune donnée à afficher.",Uy="Se termine par",qy="Égale",Yy="Égal à",Ky="Étendre tous les groupes",Qy="Exporter en format CSV",Zy="Exporter vers Excel",Jy="Exporter vers PDF",Xy="Exporter en format texte (délimité par tabulation)",eS="Exporter en format texte",tS="Raccourcis de filtre",iS="{{from}}-{{to}} de {{totalItems}} éléments",aS="Ajustement forcé des colonnes",rS="Geler les colonnes",nS="Plus grand que",oS="Plus grand ou égal à",lS="Grouper par",sS="Cacher la colonne",dS="Recherche incluant certain éléments d'une collection, doit être séparé par une virgule (a,b)",cS="Le nombre doit être valide et avoir un maximum de {{maxDecimal}} décimales.",uS="éléments",mS="éléments par page",pS="éléments sélectionnés",hS="Dernière mise à jour",gS="Plus petit que",bS="Plus petit ou égal à",fS="Chargement...",vS="Aucun élément trouvé",_S="Ne contient pas",yS="Non égal à",SS="Recherche excluant certain éléments d'une collection, doit être séparé par une virgule (a,b)",CS="de",wS="Terminé",xS="Page",TS="page {{x}} de {{y}}",ES="Rafraîchir les données",$S="Supprimer le filtre",kS="Supprimer le tri",OS="Réinitialiser la valeur",DS="Réinitialiser le formulaire",MS="Sauvegarder",PS="Sélectionner tout",IS="Trier par ordre croissant",GS="Trier par ordre décroissant",FS="Commence par",AS="Redimension synchrone",RS="Basculer la ligne des filtres",LS="Basculer la ligne de pré-en-tête",zS="Dégeler les colonnes",NS="# de % sélectionnés",WS="{{x}} de {{y}} sélectionnés",BS={ADDRESS:{STREET:"Adresse de facturation",ZIP:"Code zip de facturation"},INFORMATION:"Information de Facturation"},jS="Valeurs nulles",VS="Valeurs non-nulles",HS="Durée",US="Compagnie",qS="Terminé",YS="Changer l'indicateur terminé",KS="Changer la priorité",QS="Commandes Personnalisées",ZS="Information Client",JS="Supprimer la ligne",XS="Commande désactivée",eC="Faux",tC="Féminin",iC="Fin",aC="Future",rC="Sexe",nC="Aide",oC="Haut",lC="Bas",sC="Moyen",dC="Masculin",cC="Nom",uC="20 prochain jours",mC="Aucun",pC="Passé",hC="% Achevée",gC="Priorité",bC="Début",fC="Tâche {{x}}",vC="Titre",_C="Aujourd'hui",yC="Vrai",SC="{{x}} journée{{plural}}",CC="Mettre à jour la ligne actuelle",wC="Annuler la ligne actuelle",xC={ALL_SELECTED:Oy,ALL_X_RECORDS_SELECTED:Dy,APPLY_MASS_UPDATE:My,APPLY_TO_SELECTION:Py,CANCEL:Iy,CLEAR_ALL_FILTERS:Gy,CLEAR_ALL_GROUPING:Fy,CLEAR_ALL_SORTING:Ay,CLEAR_PINNING:Ry,CLONE:Ly,COLLAPSE_ALL_GROUPS:zy,COLUMNS:Ny,COLUMN_RESIZE_BY_CONTENT:Wy,COMMANDS:By,CONTAINS:jy,COPY:Vy,EMPTY_DATA_WARNING_MESSAGE:Hy,ENDS_WITH:Uy,EQUALS:qy,EQUAL_TO:Yy,EXPAND_ALL_GROUPS:Ky,EXPORT_TO_CSV:Qy,EXPORT_TO_EXCEL:Zy,EXPORT_TO_PDF:Jy,EXPORT_TO_TAB_DELIMITED:Xy,EXPORT_TO_TEXT_FORMAT:eS,FILTER_SHORTCUTS:tS,FROM_TO_OF_TOTAL_ITEMS:iS,FORCE_FIT_COLUMNS:aS,FREEZE_COLUMNS:rS,GREATER_THAN:nS,GREATER_THAN_OR_EQUAL_TO:oS,GROUP_BY:lS,HIDE_COLUMN:sS,IN_COLLECTION_SEPERATED_BY_COMMA:dS,INVALID_FLOAT:cS,ITEMS:uS,ITEMS_PER_PAGE:mS,ITEMS_SELECTED:pS,LAST_UPDATE:hS,LESS_THAN:gS,LESS_THAN_OR_EQUAL_TO:bS,LOADING:fS,NO_ELEMENTS_FOUND:vS,NOT_CONTAINS:_S,NOT_EQUAL_TO:yS,NOT_IN_COLLECTION_SEPERATED_BY_COMMA:SS,OF:CS,OK:wS,PAGE:xS,PAGE_X_OF_Y:TS,REFRESH_DATASET:ES,REMOVE_FILTER:$S,REMOVE_SORT:kS,RESET_INPUT_VALUE:OS,RESET_FORM:DS,SAVE:MS,SELECT_ALL:PS,SORT_ASCENDING:IS,SORT_DESCENDING:GS,STARTS_WITH:FS,SYNCHRONOUS_RESIZE:AS,TOGGLE_FILTER_ROW:RS,TOGGLE_PRE_HEADER_ROW:LS,UNFREEZE_COLUMNS:zS,X_OF_Y_SELECTED:NS,X_OF_Y_MASS_SELECTED:WS,BILLING:BS,BLANK_VALUES:jS,NON_BLANK_VALUES:VS,DURATION:HS,COMPANY:US,COMPLETED:qS,CHANGE_COMPLETED_FLAG:YS,CHANGE_PRIORITY:KS,CUSTOM_COMMANDS:QS,CUSTOMER_INFORMATION:ZS,DELETE_ROW:JS,DISABLED_COMMAND:XS,FALSE:eC,FEMALE:tC,FINISH:iC,FUTURE:aC,GENDER:rC,HELP:nC,HIGH:oC,LOW:lC,MEDIUM:sC,MALE:dC,NAME:cC,NEXT_20_DAYS:uC,NONE:mC,PAST:pC,PERCENT_COMPLETE:hC,PRIORITY:gC,START:bC,TASK_X:fC,TITLE:vC,"TITLE.NAME":"Nom du Titre",TODAY:_C,TRUE:yC,X_DAY_PLURAL:SC,RBE_BTN_UPDATE:CC,RBE_BTN_CANCEL:wC};var TC=Object.create,co=Object.defineProperty,EC=Object.getOwnPropertyDescriptor,$C=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Hd=t=>{throw TypeError(t)},kC=(t,e,i)=>e in t?co(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,OC=(t,e)=>co(t,"name",{value:e,configurable:!0}),DC=t=>[,,,TC(null)],MC=["class","method","getter","setter","accessor","field","value","get","set"],Ud=t=>t!==void 0&&typeof t!="function"?Hd("Function expected"):t,PC=(t,e,i,r,a)=>({kind:MC[t],name:e,metadata:r,addInitializer:n=>i._?Hd("Already initialized"):a.push(Ud(n||null))}),IC=(t,e)=>kC(e,$C("metadata"),t[3]),GC=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},FC=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&EC(a,i));OC(a,i);for(var p=r.length-1;p>=0;p--)u=PC(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Ud(l)&&(a=l);return IC(t,a),c&&co(a,i,c),m?s^4?n:c:a},qd,uo;qd=[ao("dateFormat")];class Mi{toView(e,i){return be(e,i)}}uo=DC();Mi=FC(uo,0,"DateFormatValueConverter",qd,Mi);GC(uo,1,Mi);var AC=Object.create,mo=Object.defineProperty,RC=Object.getOwnPropertyDescriptor,LC=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Yd=t=>{throw TypeError(t)},zC=(t,e,i)=>e in t?mo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,NC=(t,e)=>mo(t,"name",{value:e,configurable:!0}),WC=t=>[,,,AC(null)],BC=["class","method","getter","setter","accessor","field","value","get","set"],Kd=t=>t!==void 0&&typeof t!="function"?Yd("Function expected"):t,jC=(t,e,i,r,a)=>({kind:BC[t],name:e,metadata:r,addInitializer:n=>i._?Yd("Already initialized"):a.push(Kd(n||null))}),VC=(t,e)=>zC(e,LC("metadata"),t[3]),HC=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},UC=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&RC(a,i));NC(a,i);for(var p=r.length-1;p>=0;p--)u=jC(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Kd(l)&&(a=l);return VC(t,a),c&&mo(a,i,c),m?s^4?n:c:a},Qd,po;Qd=[ao("decimal")];class Pi{toView(e,i){const r=typeof i=="string"?parseInt(i,10):2,a=typeof e<"u"?parseFloat(e).toFixed(r):e;return e&&`${a}`}}po=WC();Pi=UC(po,0,"DecimalValueConverter",Qd,Pi);HC(po,1,Pi);var qC=Object.create,ho=Object.defineProperty,YC=Object.getOwnPropertyDescriptor,KC=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Zd=t=>{throw TypeError(t)},QC=(t,e,i)=>e in t?ho(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,ZC=(t,e)=>ho(t,"name",{value:e,configurable:!0}),JC=t=>[,,,qC(null)],XC=["class","method","getter","setter","accessor","field","value","get","set"],Jd=t=>t!==void 0&&typeof t!="function"?Zd("Function expected"):t,e0=(t,e,i,r,a)=>({kind:XC[t],name:e,metadata:r,addInitializer:n=>i._?Zd("Already initialized"):a.push(Jd(n||null))}),t0=(t,e)=>QC(e,KC("metadata"),t[3]),i0=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},a0=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&YC(a,i));ZC(a,i);for(var p=r.length-1;p>=0;p--)u=e0(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Jd(l)&&(a=l);return t0(t,a),c&&ho(a,i,c),m?s^4?n:c:a},Xd,go;Xd=[ao("stringify")];class Ii{toView(e){return JSON.stringify(e,null,4)}}go=JC();Ii=a0(go,0,"StringifyValueConverter",Xd,Ii);i0(go,1,Ii);var r0=Object.create,bo=Object.defineProperty,n0=Object.getOwnPropertyDescriptor,o0=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),li=t=>{throw TypeError(t)},ec=(t,e,i)=>e in t?bo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,zs=(t,e)=>bo(t,"name",{value:e,configurable:!0}),l0=t=>[,,,r0(null)],tc=["class","method","getter","setter","accessor","field","value","get","set"],At=t=>t!==void 0&&typeof t!="function"?li("Function expected"):t,s0=(t,e,i,r,a)=>({kind:tc[t],name:e,metadata:r,addInitializer:n=>i._?li("Already initialized"):a.push(At(n||null))}),d0=(t,e)=>ec(e,o0("metadata"),t[3]),Hr=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},ic=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=tc[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&n0(o<4?a:{get[i](){return Ns(this,n)},set[i](h){return Ws(this,n,h)}},i));o?c&&o<4&&zs(n,(o>2?"set ":o>1?"get ":"")+i):zs(a,i);for(var y=r.length-1;y>=0;y--)s=s0(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>u0(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?Ns:m0)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Ws(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?At(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?li("Object expected"):(At(l=d.get)&&(b.get=l),At(l=d.set)&&(b.set=l),At(l=d.init)&&w.unshift(l));return o||d0(t,a),b&&bo(a,i,b),c?o^4?n:b:a},c0=(t,e,i)=>ec(t,e+"",i),fo=(t,e,i)=>e.has(t)||li("Cannot "+i),u0=(t,e)=>Object(e)!==e?li('Cannot use the "in" operator on this value'):t.has(e),Ns=(t,e,i)=>(fo(t,e,"read from private field"),i?i.call(t):e.get(t)),Ws=(t,e,i,r)=>(fo(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),m0=(t,e,i)=>(fo(t,e,"access private method"),i),ac,rc,ct;rc=[T({name:"custom-title-formatter",template:'<span style="font-weight: bold" innerhtml.bind="model.assignee.name"></span></template>'})],ac=[O()];class ut{constructor(){c0(this,"model",Hr(ct,8,this)),Hr(ct,11,this)}}ct=l0();ic(ct,5,"model",ac,ut);ut=ic(ct,0,"CustomTitleFormatter",rc,ut);Hr(ct,1,ut);const nc="editor-select",Ur=`<div>
...
`,oc=[],lc={};let Ga;function p0(t){Ga||(Ga=E.define({name:nc,template:Ur,dependencies:oc,bindables:lc})),t.register(Ga)}const h0=Object.freeze(Object.defineProperty({__proto__:null,bindables:lc,default:Ur,dependencies:oc,name:nc,register:p0,template:Ur},Symbol.toStringTag,{value:"Module"}));var g0=Object.create,vo=Object.defineProperty,b0=Object.getOwnPropertyDescriptor,f0=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),si=t=>{throw TypeError(t)},sc=(t,e,i)=>e in t?vo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Bs=(t,e)=>vo(t,"name",{value:e,configurable:!0}),v0=t=>[,,,g0(null)],dc=["class","method","getter","setter","accessor","field","value","get","set"],Rt=t=>t!==void 0&&typeof t!="function"?si("Function expected"):t,_0=(t,e,i,r,a)=>({kind:dc[t],name:e,metadata:r,addInitializer:n=>i._?si("Already initialized"):a.push(Rt(n||null))}),y0=(t,e)=>sc(e,f0("metadata"),t[3]),Ze=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},ka=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=dc[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&b0(o<4?a:{get[i](){return js(this,n)},set[i](h){return Vs(this,n,h)}},i));o?c&&o<4&&Bs(n,(o>2?"set ":o>1?"get ":"")+i):Bs(a,i);for(var y=r.length-1;y>=0;y--)s=_0(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>S0(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?js:C0)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Vs(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Rt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?si("Object expected"):(Rt(l=d.get)&&(b.get=l),Rt(l=d.set)&&(b.set=l),Rt(l=d.init)&&w.unshift(l));return o||y0(t,a),b&&vo(a,i,b),c?o^4?n:b:a},Ci=(t,e,i)=>sc(t,typeof e!="symbol"?e+"":e,i),_o=(t,e,i)=>e.has(t)||si("Cannot "+i),S0=(t,e)=>Object(e)!==e?si('Cannot use the "in" operator on this value'):t.has(e),js=(t,e,i)=>(_o(t,e,"read from private field"),i?i.call(t):e.get(t)),Vs=(t,e,i,r)=>(_o(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),C0=(t,e,i)=>(_o(t,e,"access private method"),i),cc,uc,mc,pc,Q;pc=[T(h0)],mc=[O()],uc=[O()],cc=[O];class Ve{constructor(e=M(HTMLElement)){this.elm=e,Ci(this,"model",Ze(Q,8,this)),Ze(Q,11,this),Ci(this,"grid",Ze(Q,12,this)),Ze(Q,15,this),Ci(this,"selectedItem",Ze(Q,16,this)),Ze(Q,19,this),Ci(this,"itemMatcher",(i,r)=>i&&r&&i.id===r.id)}focus(){this.elm.querySelector("select")?.focus()}hide(){this.elm.style.display="none"}show(){this.elm.style.display="block"}selectedItemChanged(){}}Q=v0();ka(Q,5,"model",mc,Ve);ka(Q,5,"grid",uc,Ve);ka(Q,5,"selectedItem",cc,Ve);Ve=ka(Q,0,"EditorSelect",pc,Ve);Ze(Q,1,Ve);var w0=Object.create,yo=Object.defineProperty,x0=Object.getOwnPropertyDescriptor,T0=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),hc=t=>{throw TypeError(t)},E0=(t,e,i)=>e in t?yo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,$0=(t,e)=>yo(t,"name",{value:e,configurable:!0}),k0=t=>[,,,w0(null)],O0=["class","method","getter","setter","accessor","field","value","get","set"],gc=t=>t!==void 0&&typeof t!="function"?hc("Function expected"):t,D0=(t,e,i,r,a)=>({kind:O0[t],name:e,metadata:r,addInitializer:n=>i._?hc("Already initialized"):a.push(gc(n||null))}),M0=(t,e)=>E0(e,T0("metadata"),t[3]),P0=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},I0=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&x0(a,i));$0(a,i);for(var p=r.length-1;p>=0;p--)u=D0(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,gc(l)&&(a=l);return M0(t,a),c&&yo(a,i,c),m?s^4?n:c:a},bc,So;bc=[T({name:"example-detail-preload",template:`<div class="container-fluid d-flex align-items-center" style="margin-top: 10px">
    <i class="mdi mdi-sync mdi-spin font-50px"></i>
    <h4>Loading...</h4>
  </div>`})];class mt{dispose(){console.log("preload detaching")}}So=k0();mt=I0(So,0,"ExampleDetailPreload",bc,mt);P0(So,1,mt);const fc="example19-detail-view",qr=`<div class="container-fluid" style="margin-top: 10px">
  <h3>\${model.title}</h3>
  <div class="row">
...
`,vc=[],_c={};let Fa;function G0(t){Fa||(Fa=E.define({name:fc,template:qr,dependencies:vc,bindables:_c})),t.register(Fa)}const F0=Object.freeze(Object.defineProperty({__proto__:null,bindables:_c,default:qr,dependencies:vc,name:fc,register:G0,template:qr},Symbol.toStringTag,{value:"Module"}));var A0=Object.create,Co=Object.defineProperty,R0=Object.getOwnPropertyDescriptor,L0=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),di=t=>{throw TypeError(t)},yc=(t,e,i)=>e in t?Co(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Hs=(t,e)=>Co(t,"name",{value:e,configurable:!0}),z0=t=>[,,,A0(null)],Sc=["class","method","getter","setter","accessor","field","value","get","set"],Lt=t=>t!==void 0&&typeof t!="function"?di("Function expected"):t,N0=(t,e,i,r,a)=>({kind:Sc[t],name:e,metadata:r,addInitializer:n=>i._?di("Already initialized"):a.push(Lt(n||null))}),W0=(t,e)=>yc(e,L0("metadata"),t[3]),ae=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Tt=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Sc[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&R0(o<4?a:{get[i](){return Us(this,n)},set[i](h){return qs(this,n,h)}},i));o?c&&o<4&&Hs(n,(o>2?"set ":o>1?"get ":"")+i):Hs(a,i);for(var y=r.length-1;y>=0;y--)s=N0(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>B0(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?Us:j0)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>qs(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Lt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?di("Object expected"):(Lt(l=d.get)&&(b.get=l),Lt(l=d.set)&&(b.set=l),Lt(l=d.init)&&w.unshift(l));return o||W0(t,a),b&&Co(a,i,b),c?o^4?n:b:a},$t=(t,e,i)=>yc(t,typeof e!="symbol"?e+"":e,i),wo=(t,e,i)=>e.has(t)||di("Cannot "+i),B0=(t,e)=>Object(e)!==e?di('Cannot use the "in" operator on this value'):t.has(e),Us=(t,e,i)=>(wo(t,e,"read from private field"),i?i.call(t):e.get(t)),qs=(t,e,i,r)=>(wo(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),j0=(t,e,i)=>(wo(t,e,"access private method"),i),Cc,wc,xc,Tc,Ec,$c,A;$c=[T(F0)],Ec=[O()],Tc=[O()],xc=[O()],wc=[O()],Cc=[O()];class fe{constructor(){$t(this,"model",ae(A,8,this)),ae(A,11,this),$t(this,"addon",ae(A,12,this)),ae(A,15,this),$t(this,"grid",ae(A,16,this)),ae(A,19,this),$t(this,"dataView",ae(A,20,this)),ae(A,23,this),$t(this,"parentRef",ae(A,24,this)),ae(A,27,this)}alertAssignee(e){alert(typeof e=="string"?`Assignee on this task is: ${e.toUpperCase()}`:"No one is assigned to this task.")}deleteRow(e){confirm(`Are you sure that you want to delete ${e.title}?`)&&(this.addon.collapseAll(),this.dataView.deleteItem(e.rowId),this.parentRef.showFlashMessage(`Deleted row with ${e.title}`,"danger"))}callParentMethod(e){this.parentRef.showFlashMessage(`We just called Parent Method from the Row Detail Child Component on ${e.title}`)}}A=z0();Tt(A,5,"model",Ec,fe);Tt(A,5,"addon",Tc,fe);Tt(A,5,"grid",xc,fe);Tt(A,5,"dataView",wc,fe);Tt(A,5,"parentRef",Cc,fe);fe=Tt(A,0,"Example19DetailView",$c,fe);ae(A,1,fe);var V0=Object.create,xo=Object.defineProperty,H0=Object.getOwnPropertyDescriptor,U0=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),ci=t=>{throw TypeError(t)},kc=(t,e,i)=>e in t?xo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Ys=(t,e)=>xo(t,"name",{value:e,configurable:!0}),q0=t=>[,,,V0(null)],Oc=["class","method","getter","setter","accessor","field","value","get","set"],zt=t=>t!==void 0&&typeof t!="function"?ci("Function expected"):t,Y0=(t,e,i,r,a)=>({kind:Oc[t],name:e,metadata:r,addInitializer:n=>i._?ci("Already initialized"):a.push(zt(n||null))}),K0=(t,e)=>kc(e,U0("metadata"),t[3]),Yr=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Dc=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Oc[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&H0(o<4?a:{get[i](){return Ks(this,n)},set[i](h){return Qs(this,n,h)}},i));o?c&&o<4&&Ys(n,(o>2?"set ":o>1?"get ":"")+i):Ys(a,i);for(var y=r.length-1;y>=0;y--)s=Y0(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>Q0(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?Ks:Z0)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Qs(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?zt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?ci("Object expected"):(zt(l=d.get)&&(b.get=l),zt(l=d.set)&&(b.set=l),zt(l=d.init)&&w.unshift(l));return o||K0(t,a),b&&xo(a,i,b),c?o^4?n:b:a},at=(t,e,i)=>kc(t,typeof e!="symbol"?e+"":e,i),To=(t,e,i)=>e.has(t)||ci("Cannot "+i),Q0=(t,e)=>Object(e)!==e?ci('Cannot use the "in" operator on this value'):t.has(e),Ks=(t,e,i)=>(To(t,e,"read from private field"),i?i.call(t):e.get(t)),Qs=(t,e,i,r)=>(To(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),Z0=(t,e,i)=>(To(t,e,"access private method"),i),Mc,Pc,pt;Pc=[T({name:"custom-pager",template:`<div class="custom-pagination">
...
`,Gc=[],Fc={};let Aa;function J0(t){Aa||(Aa=E.define({name:Ic,template:Kr,dependencies:Gc,bindables:Fc})),t.register(Aa)}const X0=Object.freeze(Object.defineProperty({__proto__:null,bindables:Fc,default:Kr,dependencies:Gc,name:Ic,register:J0,template:Kr},Symbol.toStringTag,{value:"Module"}));var ew=Object.create,Eo=Object.defineProperty,tw=Object.getOwnPropertyDescriptor,iw=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),ui=t=>{throw TypeError(t)},Ac=(t,e,i)=>e in t?Eo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Zs=(t,e)=>Eo(t,"name",{value:e,configurable:!0}),aw=t=>[,,,ew(null)],Rc=["class","method","getter","setter","accessor","field","value","get","set"],Nt=t=>t!==void 0&&typeof t!="function"?ui("Function expected"):t,rw=(t,e,i,r,a)=>({kind:Rc[t],name:e,metadata:r,addInitializer:n=>i._?ui("Already initialized"):a.push(Nt(n||null))}),nw=(t,e)=>Ac(e,iw("metadata"),t[3]),Qr=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Lc=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Rc[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&tw(o<4?a:{get[i](){return Js(this,n)},set[i](h){return Xs(this,n,h)}},i));o?c&&o<4&&Zs(n,(o>2?"set ":o>1?"get ":"")+i):Zs(a,i);for(var y=r.length-1;y>=0;y--)s=rw(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>ow(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?Js:lw)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Xs(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Nt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?ui("Object expected"):(Nt(l=d.get)&&(b.get=l),Nt(l=d.set)&&(b.set=l),Nt(l=d.init)&&w.unshift(l));return o||nw(t,a),b&&Eo(a,i,b),c?o^4?n:b:a},Re=(t,e,i)=>Ac(t,typeof e!="symbol"?e+"":e,i),$o=(t,e,i)=>e.has(t)||ui("Cannot "+i),ow=(t,e)=>Object(e)!==e?ui('Cannot use the "in" operator on this value'):t.has(e),Js=(t,e,i)=>($o(t,e,"read from private field"),i?i.call(t):e.get(t)),Xs=(t,e,i,r)=>($o(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),lw=(t,e,i)=>($o(t,e,"access private method"),i),zc,Nc,gt;Nc=[T(X0)],zc=[O()];class bt{constructor(){Re(this,"model",Qr(gt,8,this)),Qr(gt,11,this),Re(this,"innerColDefs",[]),Re(this,"innerGridOptions"),Re(this,"aureliaGrid"),Re(this,"innerDataset",[]),Re(this,"showGrid",!1),Re(this,"gridId",""),Re(this,"innerGridClass","")}attached(){this.gridId=`innergrid-${this.model.id}`,this.innerGridClass=`row-detail-${this.model.id}`,this.defineGrid(),this.innerDataset=[...this.model.orderData],this.showGrid=!0}aureliaGridReady(e){this.aureliaGrid=e}defineGrid(){let e;if(this.model.isUsingInnerGridStatePresets){const i=sessionStorage.getItem(`gridstate_${this.innerGridClass}`);i&&(e=JSON.parse(i))}this.innerColDefs=[{id:"orderId",field:"orderId",name:"Order ID",filterable:!0,sortable:!0},{id:"shipCity",field:"shipCity",name:"Ship City",filterable:!0,sortable:!0},{id:"freight",field:"freight",name:"Freight",filterable:!0,sortable:!0,type:"number"},{id:"shipName",field:"shipName",name:"Ship Name",filterable:!0,sortable:!0}],this.innerGridOptions={autoResize:{container:`.${this.innerGridClass}`,rightPadding:30,minHeight:200},enableFiltering:!0,enableSorting:!0,rowHeight:33,enableCellNavigation:!0,datasetIdPropertyName:"orderId",presets:e,rowTopOffsetRenderType:"top"}}handleBeforeGridDestroy(){if(console.log("handleBeforeGridDestroy",this.model),this.model.isUsingInnerGridStatePresets){const e=this.aureliaGrid.gridStateService.getCurrentGridState();sessionStorage.setItem(`gridstate_${this.innerGridClass}`,JSON.stringify(e))}}}gt=aw();Lc(gt,5,"model",zc,bt);bt=Lc(gt,0,"Example45DetailView",Nc,bt);Qr(gt,1,bt);var sw=Object.create,ko=Object.defineProperty,dw=Object.getOwnPropertyDescriptor,cw=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Wc=t=>{throw TypeError(t)},uw=(t,e,i)=>e in t?ko(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,mw=(t,e)=>ko(t,"name",{value:e,configurable:!0}),pw=t=>[,,,sw(null)],hw=["class","method","getter","setter","accessor","field","value","get","set"],Bc=t=>t!==void 0&&typeof t!="function"?Wc("Function expected"):t,gw=(t,e,i,r,a)=>({kind:hw[t],name:e,metadata:r,addInitializer:n=>i._?Wc("Already initialized"):a.push(Bc(n||null))}),bw=(t,e)=>uw(e,cw("metadata"),t[3]),fw=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},vw=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&dw(a,i));mw(a,i);for(var p=r.length-1;p>=0;p--)u=gw(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Bc(l)&&(a=l);return bw(t,a),c&&ko(a,i,c),m?s^4?n:c:a},jc,Oo;jc=[T({name:"example45-preload",template:`<div class="container-fluid d-flex align-items-center" style="margin-top: 10px">
    <i class="mdi mdi-sync mdi-spin font-50px"></i>
    <h4>Loading...</h4>
  </div>`})];class ei{dispose(){console.log("preload detaching")}}Oo=pw();ei=vw(Oo,0,"Example45Preload",jc,ei);fw(Oo,1,ei);const Vc="example47-detail-view",Zr=`<div class="container-fluid" style="margin-top: 10px">
  <h3>\${model.title}</h3>
  <div class="row">
...
`,Hc=[],Uc={};let Ra;function _w(t){Ra||(Ra=E.define({name:Vc,template:Zr,dependencies:Hc,bindables:Uc})),t.register(Ra)}const yw=Object.freeze(Object.defineProperty({__proto__:null,bindables:Uc,default:Zr,dependencies:Hc,name:Vc,register:_w,template:Zr},Symbol.toStringTag,{value:"Module"}));function kt(t,e,i=!0){const r=Math.random()*(e-t+1)+t;return i?Math.floor(r):r}function Jr(t,e,i=2e3){const r=document.createElement("div");r.setAttribute("popover",""),r.className=`toast align-items-center text-bg-${e} border-0`,r.style.position="absolute",r.style.zIndex="9999";const a=document.createElement("div");if(a.className="toast-body",a.textContent=t,r.appendChild(a),document.body.appendChild(r),typeof r.showPopover=="function"){r.style.display="block",r.style.margin="0 auto",r.style.marginTop="20px",r.style.borderWidth="0px",r.showPopover(),setTimeout(()=>{r.hidePopover(),r.remove()},i);return}}function rt(t){const e=parseInt(t,10);return e<10?`0${e}`:e}var Sw=Object.create,Do=Object.defineProperty,Cw=Object.getOwnPropertyDescriptor,ww=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),mi=t=>{throw TypeError(t)},qc=(t,e,i)=>e in t?Do(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,ed=(t,e)=>Do(t,"name",{value:e,configurable:!0}),xw=t=>[,,,Sw(null)],Yc=["class","method","getter","setter","accessor","field","value","get","set"],Wt=t=>t!==void 0&&typeof t!="function"?mi("Function expected"):t,Tw=(t,e,i,r,a)=>({kind:Yc[t],name:e,metadata:r,addInitializer:n=>i._?mi("Already initialized"):a.push(Wt(n||null))}),Ew=(t,e)=>qc(e,ww("metadata"),t[3]),re=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Et=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Yc[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&Cw(o<4?a:{get[i](){return td(this,n)},set[i](h){return id(this,n,h)}},i));o?c&&o<4&&ed(n,(o>2?"set ":o>1?"get ":"")+i):ed(a,i);for(var y=r.length-1;y>=0;y--)s=Tw(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>$w(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?td:kw)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>id(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Wt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?mi("Object expected"):(Wt(l=d.get)&&(b.get=l),Wt(l=d.set)&&(b.set=l),Wt(l=d.init)&&w.unshift(l));return o||Ew(t,a),b&&Do(a,i,b),c?o^4?n:b:a},Ot=(t,e,i)=>qc(t,typeof e!="symbol"?e+"":e,i),Mo=(t,e,i)=>e.has(t)||mi("Cannot "+i),$w=(t,e)=>Object(e)!==e?mi('Cannot use the "in" operator on this value'):t.has(e),td=(t,e,i)=>(Mo(t,e,"read from private field"),i?i.call(t):e.get(t)),id=(t,e,i,r)=>(Mo(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),kw=(t,e,i)=>(Mo(t,e,"access private method"),i),Kc,Qc,Zc,Jc,Xc,eu,R;eu=[T(yw)],Xc=[O()],Jc=[O()],Zc=[O()],Qc=[O()],Kc=[O()];class ve{constructor(){Ot(this,"model",re(R,8,this)),re(R,11,this),Ot(this,"addon",re(R,12,this)),re(R,15,this),Ot(this,"grid",re(R,16,this)),re(R,19,this),Ot(this,"dataView",re(R,20,this)),re(R,23,this),Ot(this,"parentRef",re(R,24,this)),re(R,27,this)}alertAssignee(e){alert(typeof e=="string"?`Assignee on this task is: ${e.toUpperCase()}`:"No one is assigned to this task.")}deleteRow(e){confirm(`Are you sure that you want to delete ${e.title}?`)&&(this.addon.collapseAll(),this.dataView.deleteItem(e.id),Jr(`Deleted row with ${e.title}`,"danger"))}showNotification(e){Jr(`We just called Parent Method from the Row Detail Child Component on ${e.title}`,"info")}}R=xw();Et(R,5,"model",Xc,ve);Et(R,5,"addon",Jc,ve);Et(R,5,"grid",Zc,ve);Et(R,5,"dataView",Qc,ve);Et(R,5,"parentRef",Kc,ve);ve=Et(R,0,"Example47DetailView",eu,ve);re(R,1,ve);const tu="filter-select",Xr=`<div>
  <span if.bind="model.collection">
    <select class="form-control form-select" value.bind="selectedItem" matcher.bind="itemMatcher">
      <option repeat.for="item of model.collection" model.bind="item">\${item.name}</option>
    </select>
...
`,iu=[],au={};let La;function Ow(t){La||(La=E.define({name:tu,template:Xr,dependencies:iu,bindables:au})),t.register(La)}const Dw=Object.freeze(Object.defineProperty({__proto__:null,bindables:au,default:Xr,dependencies:iu,name:tu,register:Ow,template:Xr},Symbol.toStringTag,{value:"Module"}));var Mw=Object.create,Po=Object.defineProperty,Pw=Object.getOwnPropertyDescriptor,Iw=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),pi=t=>{throw TypeError(t)},ru=(t,e,i)=>e in t?Po(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,ad=(t,e)=>Po(t,"name",{value:e,configurable:!0}),Gw=t=>[,,,Mw(null)],nu=["class","method","getter","setter","accessor","field","value","get","set"],Bt=t=>t!==void 0&&typeof t!="function"?pi("Function expected"):t,Fw=(t,e,i,r,a)=>({kind:nu[t],name:e,metadata:r,addInitializer:n=>i._?pi("Already initialized"):a.push(Bt(n||null))}),Aw=(t,e)=>ru(e,Iw("metadata"),t[3]),Je=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Oa=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=nu[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&Pw(o<4?a:{get[i](){return rd(this,n)},set[i](h){return nd(this,n,h)}},i));o?c&&o<4&&ad(n,(o>2?"set ":o>1?"get ":"")+i):ad(a,i);for(var y=r.length-1;y>=0;y--)s=Fw(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>Rw(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?rd:Lw)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>nd(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Bt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?pi("Object expected"):(Bt(l=d.get)&&(b.get=l),Bt(l=d.set)&&(b.set=l),Bt(l=d.init)&&w.unshift(l));return o||Aw(t,a),b&&Po(a,i,b),c?o^4?n:b:a},wi=(t,e,i)=>ru(t,typeof e!="symbol"?e+"":e,i),Io=(t,e,i)=>e.has(t)||pi("Cannot "+i),Rw=(t,e)=>Object(e)!==e?pi('Cannot use the "in" operator on this value'):t.has(e),rd=(t,e,i)=>(Io(t,e,"read from private field"),i?i.call(t):e.get(t)),nd=(t,e,i,r)=>(Io(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),Lw=(t,e,i)=>(Io(t,e,"access private method"),i),ou,lu,su,du,Z;du=[T(Dw)],su=[O()],lu=[O()],ou=[O];class Ae{constructor(e=M(HTMLElement)){this.elm=e,wi(this,"model",Je(Z,8,this)),Je(Z,11,this),wi(this,"grid",Je(Z,12,this)),Je(Z,15,this),wi(this,"selectedItem",Je(Z,16,this)),Je(Z,19,this),wi(this,"itemMatcher",(i,r)=>i&&r&&i.id===r.id)}focus(){this.elm.querySelector("select")?.focus()}selectedItemChanged(){}}Z=Gw();Oa(Z,5,"model",su,Ae);Oa(Z,5,"grid",lu,Ae);Oa(Z,5,"selectedItem",ou,Ae);Ae=Oa(Z,0,"FilterSelect",du,Ae);Je(Z,1,Ae);const zw="modulepreload",Nw=function(t,e){return new URL(t,e).href},od={},$=function(e,i,r){let a=Promise.resolve();if(i&&i.length>0){let s=function(m){return Promise.all(m.map(o=>Promise.resolve(o).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};const l=document.getElementsByTagName("link"),d=document.querySelector("meta[property=csp-nonce]"),u=d?.nonce||d?.getAttribute("nonce");a=s(i.map(m=>{if(m=Nw(m,r),m in od)return;od[m]=!0;const o=m.endsWith(".css"),g=o?'[rel="stylesheet"]':"";if(r)for(let p=l.length-1;p>=0;p--){const _=l[p];if(_.href===m&&(!o||_.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${m}"]${g}`))return;const c=document.createElement("link");if(c.rel=o?"stylesheet":zw,o||(c.as="script"),c.crossOrigin="",c.href=m,u&&c.setAttribute("nonce",u),document.head.appendChild(c),o)return new Promise((p,_)=>{c.addEventListener("load",p),c.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${m}`)))})}))}function n(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return a.then(l=>{for(const d of l||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})},Ww=""+new URL("aurelia-logo-9YSzF-gF.png",import.meta.url).href,Bw=`<div>
...
`,lp=[],sp={};let ar;function FE(t){ar||(ar=E.define({name:op,template:bn,dependencies:lp,bindables:sp})),t.register(ar)}const AE=Object.freeze(Object.defineProperty({__proto__:null,bindables:sp,default:bn,dependencies:lp,name:op,register:FE,template:bn},Symbol.toStringTag,{value:"Module"}));var RE=Object.create,ul=Object.defineProperty,LE=Object.getOwnPropertyDescriptor,zE=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),dp=t=>{throw TypeError(t)},cp=(t,e,i)=>e in t?ul(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,NE=(t,e)=>ul(t,"name",{value:e,configurable:!0}),WE=t=>[,,,RE(null)],BE=["class","method","getter","setter","accessor","field","value","get","set"],up=t=>t!==void 0&&typeof t!="function"?dp("Function expected"):t,jE=(t,e,i,r,a)=>({kind:BE[t],name:e,metadata:r,addInitializer:n=>i._?dp("Already initialized"):a.push(up(n||null))}),VE=(t,e)=>cp(e,zE("metadata"),t[3]),HE=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},UE=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&LE(a,i));NE(a,i);for(var p=r.length-1;p>=0;p--)u=jE(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,up(l)&&(a=l);return VE(t,a),c&&ul(a,i,c),m?s^4?n:c:a},lt=(t,e,i)=>cp(t,typeof e!="symbol"?e+"":e,i),mp,ml;function Ue(t,e){return Math.floor(Math.random()*(e-t+1)+t)}const vd=25,$i="gridState",_d=500;mp=[T(AE)];class Ki{constructor(e=M(Se)){this.i18n=e,lt(this,"aureliaGrid"),lt(this,"columns",[]),lt(this,"gridOptions"),lt(this,"dataset",[]),lt(this,"hideSubTitle",!1),lt(this,"selectedLanguage","");const i=JSON.parse(localStorage[$i]||null);this.defineGrid(i);const r="en";this.i18n.setLocale(r),this.selectedLanguage=r}attached(){this.dataset=this.getData(_d)}detaching(){this.saveCurrentGridState()}aureliaGridReady(e){this.aureliaGrid=e}clearGridStateFromLocalStorage(){this.aureliaGrid.gridService.resetGrid(this.columns),this.aureliaGrid.paginationService.changeItemPerPage(vd),setTimeout(()=>localStorage[$i]=null)}defineGrid(e){const i=[];for(let r=0;r<_d;r++)i.push({value:r,label:r});this.columns=[{id:"title",name:"Title",field:"title",nameKey:"TITLE",filterable:!0,sortable:!0,minWidth:45,width:100,filter:{model:v.compoundInput}},{id:"description",name:"Description",field:"description",filterable:!0,sortable:!0,minWidth:80,width:100,filter:{model:v.input,filterShortcuts:[{titleKey:"BLANK_VALUES",searchTerms:["< A"],iconCssClass:"mdi mdi-filter-minus-outline"},{titleKey:"NON_BLANK_VALUES",searchTerms:["> A"],iconCssClass:"mdi mdi-filter-plus-outline"}]}},{id:"duration",name:"Duration (days)",field:"duration",sortable:!0,type:"number",exportCsvForceToKeepAsString:!0,minWidth:55,width:100,nameKey:"DURATION",filterable:!0,filter:{collection:i,model:v.multipleSelect,options:{maxHeight:250,width:175}}},{id:"complete",name:"% Complete",field:"percentComplete",nameKey:"PERCENT_COMPLETE",minWidth:70,type:"number",sortable:!0,width:100,formatter:f.percentCompleteBar,filterable:!0,filter:{model:v.slider,operator:">"}},{id:"start",name:"Start",field:"start",nameKey:"START",formatter:f.dateIso,sortable:!0,minWidth:75,exportWithFormatter:!0,width:100,type:"date",filterable:!0,filter:{model:v.compoundDate,filterShortcuts:[{titleKey:"PAST",searchTerms:[be(new Date,"YYYY-MM-DD")],operator:"<",iconCssClass:"mdi mdi-calendar"},{titleKey:"FUTURE",searchTerms:[be(new Date,"YYYY-MM-DD")],operator:">",iconCssClass:"mdi mdi-calendar-clock"}]}},{id:"completed",field:"completed",nameKey:"COMPLETED",minWidth:85,maxWidth:85,formatter:f.checkmarkMaterial,width:100,type:"boolean",sortable:!0,filterable:!0,filter:{collection:[{value:"",label:""},{value:!0,label:"True"},{value:!1,label:"False"}],model:v.singleSelect}}],this.gridOptions={autoResize:{container:"#demo-container",rightPadding:10},enableCheckboxSelector:!0,enableFiltering:!0,enableTranslate:!0,i18n:this.i18n,columnPicker:{hideForceFitButton:!0},gridMenu:{hideForceFitButton:!0,hideClearFrozenColumnsCommand:!1},headerMenu:{hideFreezeColumnsCommand:!1},enablePagination:!0,pagination:{pageSizes:[5,10,15,20,25,30,40,50,75,100],pageSize:vd}},e&&(this.gridOptions.presets=e)}getData(e){const i=new Date().getFullYear(),r=[];for(let a=0;a<e;a++){const n=Math.round(Math.random()*100),l=Ue(i-15,i+8),d=Ue(10,25),u=Ue(1,12),s=u<10?`0${u}`:u,m=Ue(10,28),o=Ue(0,100),g=Ue(10,23),c=Ue(10,59);r[a]={id:a,title:"Task "+a,description:a%5?"desc "+a:null,duration:n,percentComplete:o,percentCompleteNumber:o,start:new Date(l,u,m),usDateShort:`${u}/${m}/${d}`,utcDate:`${l}-${s}-${m}T${g}:${c}:${c}Z`,completed:a%3===0}}return r}gridStateChanged(e){console.log("Client sample, Grid State changed:: ",e),localStorage[$i]=JSON.stringify(e.gridState)}saveCurrentGridState(){const e=this.aureliaGrid.gridStateService.getCurrentGridState();console.log("Client sample, current Grid State:: ",e),localStorage[$i]=JSON.stringify(e)}async switchLanguage(){const e=this.selectedLanguage==="en"?"fr":"en";await this.i18n.setLocale(e),this.selectedLanguage=e}useDefaultPresets(){return{columns:[{columnId:"description",width:170},{columnId:"title",width:55},{columnId:"duration"},{columnId:"complete"},{columnId:"start"},{columnId:"usDateShort"},{columnId:"utcDate"}],filters:[{columnId:"duration",searchTerms:[2,22,44]},{columnId:"usDateShort",operator:"<",searchTerms:["4/20/25"]}],sorters:[{columnId:"duration",direction:"DESC"},{columnId:"complete",direction:"ASC"}]}}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}ml=WE();Ki=UE(ml,0,"Example15",mp,Ki);HE(ml,1,Ki);const qE=Object.freeze(Object.defineProperty({__proto__:null,get Example15(){return Ki}},Symbol.toStringTag,{value:"Module"})),pp="example16",fn=`<h2>
...
`,Sp=[],Cp={};let nr;function l$(t){nr||(nr=E.define({name:yp,template:vn,dependencies:Sp,bindables:Cp})),t.register(nr)}const s$=Object.freeze(Object.defineProperty({__proto__:null,bindables:Cp,default:vn,dependencies:Sp,name:yp,register:l$,template:vn},Symbol.toStringTag,{value:"Module"}));var d$=Object.create,gl=Object.defineProperty,c$=Object.getOwnPropertyDescriptor,u$=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),wp=t=>{throw TypeError(t)},xp=(t,e,i)=>e in t?gl(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,m$=(t,e)=>gl(t,"name",{value:e,configurable:!0}),p$=t=>[,,,d$(null)],h$=["class","method","getter","setter","accessor","field","value","get","set"],Tp=t=>t!==void 0&&typeof t!="function"?wp("Function expected"):t,g$=(t,e,i,r,a)=>({kind:h$[t],name:e,metadata:r,addInitializer:n=>i._?wp("Already initialized"):a.push(Tp(n||null))}),b$=(t,e)=>xp(e,u$("metadata"),t[3]),f$=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},v$=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&c$(a,i));m$(a,i);for(var p=r.length-1;p>=0;p--)u=g$(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Tp(l)&&(a=l);return b$(t,a),c&&gl(a,i,c),m?s^4?n:c:a},Te=(t,e,i)=>xp(t,typeof e!="symbol"?e+"":e,i),Ep,bl;const _$="assets/data";Ep=[T(s$)];class Zi{constructor(){Te(this,"aureliaGrid"),Te(this,"columns",[]),Te(this,"gridOptions"),Te(this,"gridCreated",!1),Te(this,"hideSubTitle",!1),Te(this,"dataset",[]),Te(this,"paginationPosition","top"),Te(this,"templateUrl",`${_$}/users.csv`),Te(this,"uploadFileRef","")}aureliaGridReady(e){this.aureliaGrid=e}destroyGrid(){this.gridCreated=!1}handleFileImport(e){const i=e.target.files[0];if(i.name.endsWith(".csv")){const r=new FileReader;r.onload=a=>{const n=a.target.result;this.dynamicallyCreateGrid(n)},r.readAsText(i)}else alert("File must be a CSV file")}handleDefaultCsv(){this.dynamicallyCreateGrid(`First Name,Last Name,Age,Type
Bob,Smith,33,Teacher
John,Doe,20,Student
Jane,Doe,21,Student`),this.uploadFileRef=""}dynamicallyCreateGrid(e){this.gridCreated=!1;const i=e?.split(`
`),r=[],a=[];i.forEach((n,l)=>{const d=n.split(","),u={};if(l===0)for(const s of d){const m=Cv(s);r.push({id:m,name:s,field:m,filterable:!0,sortable:!0})}else d.forEach((s,m)=>{u[r[m].id]=s}),"id"in u?a.push(u):a.push({...u,id:l})}),this.gridOptions={gridHeight:300,gridWidth:800,enableFiltering:!0,enableExcelExport:!0,externalResources:[new G],headerRowHeight:35,rowHeight:33},this.dataset=a,this.columns=r,console.log(this.columns,this.dataset),this.gridCreated=!0}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}bl=p$();Zi=v$(bl,0,"Example17",Ep,Zi);f$(bl,1,Zi);const y$=Object.freeze(Object.defineProperty({__proto__:null,get Example17(){return Zi}},Symbol.toStringTag,{value:"Module"})),$p="example18",_n=`<h2>
...
`,Qp=[],Zp={};let dr;function lk(t){dr||(dr=E.define({name:Kp,template:Cn,dependencies:Qp,bindables:Zp})),t.register(dr)}const sk=Object.freeze(Object.defineProperty({__proto__:null,bindables:Zp,default:Cn,dependencies:Qp,name:Kp,register:lk,template:Cn},Symbol.toStringTag,{value:"Module"}));var dk=Object.create,xl=Object.defineProperty,ck=Object.getOwnPropertyDescriptor,uk=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),bi=t=>{throw TypeError(t)},Jp=(t,e,i)=>e in t?xl(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,wd=(t,e)=>xl(t,"name",{value:e,configurable:!0}),mk=t=>[,,,dk(null)],Xp=["class","method","getter","setter","accessor","field","value","get","set"],Ut=t=>t!==void 0&&typeof t!="function"?bi("Function expected"):t,pk=(t,e,i,r,a)=>({kind:Xp[t],name:e,metadata:r,addInitializer:n=>i._?bi("Already initialized"):a.push(Ut(n||null))}),hk=(t,e)=>Jp(e,uk("metadata"),t[3]),Xe=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Da=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Xp[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&ck(o<4?a:{get[i](){return xd(this,n)},set[i](h){return Td(this,n,h)}},i));o?c&&o<4&&wd(n,(o>2?"set ":o>1?"get ":"")+i):wd(a,i);for(var y=r.length-1;y>=0;y--)s=pk(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>gk(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?xd:bk)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Td(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Ut(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?bi("Object expected"):(Ut(l=d.get)&&(b.get=l),Ut(l=d.set)&&(b.set=l),Ut(l=d.init)&&w.unshift(l));return o||hk(t,a),b&&xl(a,i,b),c?o^4?n:b:a},Ee=(t,e,i)=>Jp(t,typeof e!="symbol"?e+"":e,i),Tl=(t,e,i)=>e.has(t)||bi("Cannot "+i),gk=(t,e)=>Object(e)!==e?bi('Cannot use the "in" operator on this value'):t.has(e),xd=(t,e,i)=>(Tl(t,e,"read from private field"),i?i.call(t):e.get(t)),Td=(t,e,i,r)=>(Tl(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),bk=(t,e,i)=>(Tl(t,e,"access private method"),i),eh,th,ih,ah,J;ah=[T(sk)],ih=[O()],th=[O()],eh=[O()];class tt{constructor(){Ee(this,"selectedColumn",Xe(J,8,this)),Xe(J,11,this),Ee(this,"selectedOperator",Xe(J,12,this)),Xe(J,15,this),Ee(this,"searchValue",Xe(J,16,this,"")),Xe(J,19,this),Ee(this,"aureliaGrid"),Ee(this,"columns",[]),Ee(this,"gridOptions"),Ee(this,"dataset",[]),Ee(this,"hideSubTitle",!1),Ee(this,"operatorList",["=","<","<=",">",">=","<>","StartsWith","EndsWith"]),this.defineGrid()}attached(){this.getData()}defineGrid(){this.columns=[{id:"title",name:"Title",field:"title",width:100,sortable:!0},{id:"duration",name:"Duration (days)",field:"duration",width:100,sortable:!0,type:"number"},{id:"complete",name:"% Complete",field:"percentComplete",width:100,sortable:!0,formatter:f.percentCompleteBar,type:"number"},{id:"start",name:"Start",field:"start",width:100,sortable:!0,formatter:f.dateIso,type:"date"},{id:"finish",name:"Finish",field:"finish",width:100,sortable:!0,formatter:f.dateIso,type:"date"},{id:"effort-driven",name:"Effort Driven",field:"effortDriven",width:100,sortable:!0,formatter:f.checkmarkMaterial,type:"number"}],this.gridOptions={autoHeight:!0,autoResize:{container:"#demo-container",rightPadding:10},enableFiltering:!0,showHeaderRow:!1,alwaysShowVerticalScroll:!1,enableColumnPicker:!0,enableCellNavigation:!0,enableSelection:!0}}getData(){const e=[];for(let i=0;i<25;i++){const r=2e3+Math.floor(Math.random()*10),a=Math.floor(Math.random()*11),n=Math.floor(Math.random()*29),l=Math.round(Math.random()*100);e[i]={id:i,title:"Task "+i,duration:Math.round(Math.random()*100)+"",percentComplete:l,percentCompleteNumber:l,start:new Date(r,a,n),finish:new Date(r,a+1,n),effortDriven:i%5===0}}this.dataset=e}clearGridSearchInput(){this.searchValue="",this.updateFilter()}selectedOperatorChanged(){this.updateFilter()}selectedColumnChanged(){this.updateFilter()}searchValueChanged(){this.updateFilter()}updateFilter(){this.aureliaGrid?.filterService.updateSingleFilter({columnId:`${this.selectedColumn.id||""}`,operator:this.selectedOperator,searchTerms:[this.searchValue||""]})}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}J=mk();Da(J,5,"selectedColumn",ih,tt);Da(J,5,"selectedOperator",th,tt);Da(J,5,"searchValue",eh,tt);tt=Da(J,0,"Example21",ah,tt);Xe(J,1,tt);const fk=Object.freeze(Object.defineProperty({__proto__:null,get Example21(){return tt}},Symbol.toStringTag,{value:"Module"})),rh="example22",wn=`<h2>
...
`,nh=[],oh={};let cr;function vk(t){cr||(cr=E.define({name:rh,template:wn,dependencies:nh,bindables:oh})),t.register(cr)}const _k=Object.freeze(Object.defineProperty({__proto__:null,bindables:oh,default:wn,dependencies:nh,name:rh,register:vk,template:wn},Symbol.toStringTag,{value:"Module"}));var yk=Object.create,El=Object.defineProperty,Sk=Object.getOwnPropertyDescriptor,Ck=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),lh=t=>{throw TypeError(t)},sh=(t,e,i)=>e in t?El(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,wk=(t,e)=>El(t,"name",{value:e,configurable:!0}),xk=t=>[,,,yk(null)],Tk=["class","method","getter","setter","accessor","field","value","get","set"],dh=t=>t!==void 0&&typeof t!="function"?lh("Function expected"):t,Ek=(t,e,i,r,a)=>({kind:Tk[t],name:e,metadata:r,addInitializer:n=>i._?lh("Already initialized"):a.push(dh(n||null))}),$k=(t,e)=>sh(e,Ck("metadata"),t[3]),kk=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},Ok=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&Sk(a,i));wk(a,i);for(var p=r.length-1;p>=0;p--)u=Ek(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,dh(l)&&(a=l);return $k(t,a),c&&El(a,i,c),m?s^4?n:c:a},We=(t,e,i)=>sh(t,typeof e!="symbol"?e+"":e,i),ch,$l;ch=[T(_k)];class ea{constructor(e=M(_e(ye))){this.http=e,We(this,"aureliaGrid2"),We(this,"gridOptions1"),We(this,"gridOptions2"),We(this,"columns1",[]),We(this,"columns2",[]),We(this,"dataset1",[]),We(this,"dataset2",[]),We(this,"hideSubTitle",!1),this.defineGrid1(),this.defineGrid2()}aureliaGrid2Ready(e){this.aureliaGrid2=e}async attached(){this.dataset1=this.mockData();const e=await fetch(ft);this.dataset2=await e.json()}defineGrid1(){this.columns1=[{id:"title",name:"Title",field:"title",sortable:!0,minWidth:100},{id:"duration",name:"Duration (days)",field:"duration",sortable:!0,minWidth:100},{id:"%",name:"% Complete",field:"percentComplete",sortable:!0,minWidth:100},{id:"start",name:"Start",field:"start",minWidth:100},{id:"finish",name:"Finish",field:"finish",minWidth:100},{id:"effort-driven",name:"Effort Driven",field:"effortDriven",sortable:!0,minWidth:100}],this.gridOptions1={enableAutoResize:!0,autoResize:{container:"#demo-container",rightPadding:10},enableSorting:!0}}defineGrid2(){this.columns2=[{id:"name",name:"Name",field:"name",filterable:!0,sortable:!0},{id:"gender",name:"Gender",field:"gender",filterable:!0,sortable:!0,filter:{model:v.singleSelect,collection:[{value:"",label:""},{value:"male",label:"male"},{value:"female",label:"female"}]}},{id:"company",name:"Company",field:"company",filterable:!0,sortable:!0}],this.gridOptions2={enableAutoResize:!0,autoResize:{container:"#demo-container",rightPadding:10},enableFiltering:!0,enableSorting:!0}}mockData(){const e=[];for(let i=0;i<1e3;i++){const r=2e3+Math.floor(Math.random()*10),a=Math.floor(Math.random()*11),n=Math.floor(Math.random()*29),l=Math.round(Math.random()*100);e[i]={id:i,title:"Task "+i,duration:Math.round(Math.random()*100)+"",percentComplete:l,start:`${a}/${n}/${r}`,finish:`${a}/${n}/${r}`,effortDriven:i%5===0}}return e}resizeGrid2(){this.aureliaGrid2.resizerService.resizeGrid(10)}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid2.resizerService.resizeGrid(0)}}$l=xk();ea=Ok($l,0,"Example22",ch,ea);kk($l,1,ea);const Dk=Object.freeze(Object.defineProperty({__proto__:null,get Example22(){return ea}},Symbol.toStringTag,{value:"Module"})),uh="example23",xn=`<h2>
...
`,ng=[wD],og={};let vr;function xD(t){vr||(vr=E.define({name:rg,template:Mn,dependencies:ng,bindables:og})),t.register(vr)}const TD=Object.freeze(Object.defineProperty({__proto__:null,bindables:og,default:Mn,dependencies:ng,name:rg,register:xD,template:Mn},Symbol.toStringTag,{value:"Module"}));var ED=Object.create,Bl=Object.defineProperty,$D=Object.getOwnPropertyDescriptor,kD=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),lg=t=>{throw TypeError(t)},sg=(t,e,i)=>e in t?Bl(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,OD=(t,e)=>Bl(t,"name",{value:e,configurable:!0}),DD=t=>[,,,ED(null)],MD=["class","method","getter","setter","accessor","field","value","get","set"],dg=t=>t!==void 0&&typeof t!="function"?lg("Function expected"):t,PD=(t,e,i,r,a)=>({kind:MD[t],name:e,metadata:r,addInitializer:n=>i._?lg("Already initialized"):a.push(dg(n||null))}),ID=(t,e)=>sg(e,kD("metadata"),t[3]),GD=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},FD=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&$D(a,i));OD(a,i);for(var p=r.length-1;p>=0;p--)u=PD(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,dg(l)&&(a=l);return ID(t,a),c&&Bl(a,i,c),m?s^4?n:c:a},ki=(t,e,i)=>sg(t,typeof e!="symbol"?e+"":e,i),cg,jl;const AD=995;cg=[T(TD)];class la{constructor(){ki(this,"gridOptions"),ki(this,"columns",[]),ki(this,"dataset",[]),ki(this,"hideSubTitle",!1),this.defineGrids()}attached(){this.dataset=this.mockData(AD)}defineGrids(){this.columns=[{id:"title",name:"Title",field:"title",sortable:!0,minWidth:100},{id:"duration",name:"Duration (days)",field:"duration",sortable:!0,minWidth:100},{id:"%",name:"% Complete",field:"percentComplete",sortable:!0,minWidth:100},{id:"start",name:"Start",field:"start",formatter:f.dateIso},{id:"finish",name:"Finish",field:"finish",formatter:f.dateIso},{id:"effort-driven",name:"Effort Driven",field:"effortDriven",sortable:!0,minWidth:100}],this.gridOptions={enableAutoResize:!1,enableSorting:!0,gridHeight:225,gridWidth:800}}mockData(e){const i=[];for(let r=0;r<e;r++){const a=2e3+Math.floor(Math.random()*10),n=Math.floor(Math.random()*11),l=Math.floor(Math.random()*29),d=Math.round(Math.random()*100);i[r]={id:r,title:"Task "+r,duration:Math.round(Math.random()*100)+"",percentComplete:d,start:new Date(a,n+1,l),finish:new Date(a+1,n+1,l),effortDriven:r%5===0}}return i}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden")}}jl=DD();la=FD(jl,0,"Example29",cg,la);GD(jl,1,la);const RD=Object.freeze(Object.defineProperty({__proto__:null,get Example29(){return la}},Symbol.toStringTag,{value:"Module"})),ug="example30",Pn=`<h2>
...
`;for(const a of i.validationResults.errors){const n=a.editor.args.column.name;r+=`${n.toUpperCase()}: ${a.msg}`}}console.log(r)}}else alert(i.validationResults.msg);return e.preventDefault(),!1}handleItemDeleted(e){console.log("item deleted with ids:",e)}handleOnBeforeEditCell(e,i){const{column:r,item:a,grid:n}=i;return r&&a&&!ZD(a,r,n)?(e.preventDefault(),!1):!0}handleOnCellChange(e,i){const r=i?.item;r&&!r.completed&&(r.finish=null,this.aureliaGrid.gridService.updateItem(r))}handleOnCellClicked(e,i){console.log(e,i)}handleOnCompositeEditorChange(e,i){const r=i.column,a=i.formValues;r.id==="percentComplete"&&a.percentComplete===100&&(this.compositeEditorInstance.changeFormInputValue("completed",!0),this.compositeEditorInstance.changeFormInputValue("finish",new Date))}handleReRenderUnsavedStyling(){this.removeAllUnsavedStylingFromCell(),this.renderUnsavedStylingOnAllVisibleCells()}handleOnGridStateChanged(e){Array.isArray(e.gridState?.rowSelection?.dataContextIds)&&(this.isMassSelectionDisabled=e.gridState?.rowSelection?.dataContextIds.length===0)}openCompositeModal(e){let i="";switch(e){case"create":i="Inserting New Task";break;case"clone":i="Clone - {{title}}";break;case"edit":i='Editing - {{title}} (<span class="text-muted">id:</span> <span class="text-primary">{{id}}</span>)';break;case"mass-update":i="Mass Update All Records";break;case"mass-selection":i="Update Selected Records";break}this.compositeEditorInstance?.openDetails({headerTitle:i,modalType:e,insertOptions:{highlightRow:!1},showFormResetButton:!0,resetFormButtonIconCssClass:"mdi mdi-undo",onClose:()=>Promise.resolve(confirm("You have unsaved changes, are you sure you want to close this window?")),onError:r=>alert(r.message),onRendered:r=>{r.dataset.bsTheme=this._darkMode?"dark":"light"},onSave:(r,a,n)=>e==="mass-update"||e==="mass-selection"?new Promise((d,u)=>{setTimeout(()=>{r.percentComplete>=50?d(!0):u("Unfortunately we only accept a minimum of 50% Completion...")},50)}):(console.log(`${e} item data context`,n),new Promise(d=>setTimeout(()=>d(!0),50)))})}toggleGridEditReadonly(){this.undoAllEdits(),this.isGridEditable=!this.isGridEditable,this.isCompositeDisabled=!this.isGridEditable,this.isGridEditable||(this.isMassSelectionDisabled=!0),this.aureliaGrid.slickGrid.setOptions({editable:this.isGridEditable})}toggleDarkMode(){this._darkMode=!this._darkMode,this.toggleBodyBackground(),this.aureliaGrid.slickGrid?.setOptions({darkMode:this._darkMode})}toggleBodyBackground(){this._darkMode?(document.querySelector(".panel-wm-content").classList.add("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="dark"):(document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light")}removeUnsavedStylingFromCell(e,i,r){const a=`unsaved_highlight_${[i.id]}${r}`;this.aureliaGrid.slickGrid.removeCellCssStyles(a);const n=this.cellCssStyleQueue.findIndex(l=>l===a);n>=0&&this.cellCssStyleQueue.splice(n,1)}removeAllUnsavedStylingFromCell(){for(const e of this.cellCssStyleQueue)this.aureliaGrid.slickGrid.removeCellCssStyles(e);this.cellCssStyleQueue=[]}renderUnsavedStylingOnAllVisibleCells(){for(const e of this.editQueue)if(e){const{item:i,columns:r,editCommand:a}=e;Array.isArray(r)&&r.forEach(n=>{this.renderUnsavedCellStyling(i,n,a)})}}renderUnsavedCellStyling(e,i,r){if(r&&e&&i){const a=this.aureliaGrid.dataView.getRowByItem(e);if(a>=0){const n={[a]:{[i.id]:"unsaved-editable-field"}},l=`unsaved_highlight_${[i.id]}${a}`;this.aureliaGrid.slickGrid.setCellCssStyles(`unsaved_highlight_${[i.id]}${a}`,n),this.cellCssStyleQueue.push(l)}}}saveAll(){console.log(this.editQueue),console.log(this.editedItems),this.removeAllUnsavedStylingFromCell(),this.editQueue=[],this.editedItems={}}undoLastEdit(e=!1){const i=this.editQueue.pop(),r=i?.editCommand;if(i&&r&&et.cancelCurrentEdit()){r.undo();for(const a of i.columns)this.removeUnsavedStylingFromCell(i.item,a,r.row);this.aureliaGrid.slickGrid.invalidate(),e&&this.aureliaGrid.slickGrid.gotoCell(r.row,r.cell,!1)}}undoAllEdits(){for(const e of this.editQueue){const i=e?.editCommand;if(i&&et.cancelCurrentEdit()){i.undo();for(const r of e.columns)this.removeUnsavedStylingFromCell(e.item,r,i.row)}}this.aureliaGrid.slickGrid.invalidate(),this.editQueue=[]}mockProducts(){return[{id:0,itemName:"Sleek Metal Computer",itemNameTranslated:"some fantastic sleek metal computer description",listPrice:2100.23,itemTypeName:"I",image:"http://i.stack.imgur.com/pC1Tv.jpg",icon:this.getRandomIcon(0)},{id:1,itemName:"Tasty Granite Table",itemNameTranslated:"an extremely huge and heavy table",listPrice:3200.12,itemTypeName:"I",image:"https://i.imgur.com/Fnm7j6h.jpg",icon:this.getRandomIcon(1)},{id:2,itemName:"Awesome Wooden Mouse",itemNameTranslated:"super old mouse",listPrice:15,itemTypeName:"I",image:"https://i.imgur.com/RaVJuLr.jpg",icon:this.getRandomIcon(2)},{id:3,itemName:"Gorgeous Fresh Shirt",itemNameTranslated:"what a gorgeous shirt seriously",listPrice:25.76,itemTypeName:"I",image:"http://i.stack.imgur.com/pC1Tv.jpg",icon:this.getRandomIcon(3)},{id:4,itemName:"Refined Cotton Table",itemNameTranslated:"super light table that will fall apart amazingly fast",listPrice:13.35,itemTypeName:"I",image:"https://i.imgur.com/Fnm7j6h.jpg",icon:this.getRandomIcon(4)},{id:5,itemName:"Intelligent Wooden Pizza",itemNameTranslated:"wood not included",listPrice:23.33,itemTypeName:"I",image:"https://i.imgur.com/RaVJuLr.jpg",icon:this.getRandomIcon(5)},{id:6,itemName:"Licensed Cotton Chips",itemNameTranslated:"not sure what that is",listPrice:71.21,itemTypeName:"I",image:"http://i.stack.imgur.com/pC1Tv.jpg",icon:this.getRandomIcon(6)},{id:7,itemName:"Ergonomic Rubber Soap",itemNameTranslated:"so good you'll want to use it every night",listPrice:2.43,itemTypeName:"I",image:"https://i.imgur.com/Fnm7j6h.jpg",icon:this.getRandomIcon(7)},{id:8,itemName:"Handcrafted Steel Car",itemNameTranslated:"aka tesla truck",listPrice:31288.39,itemTypeName:"I",image:"https://i.imgur.com/RaVJuLr.jpg",icon:this.getRandomIcon(8)}]}getRandomIcon(e){const i=["mdi-arrow-collapse","mdi-arrow-expand","mdi-cancel","mdi-check","mdi-checkbox-blank-outline","mdi-check-box-outline","mdi-checkbox-marked","mdi-close","mdi-close-circle","mdi-close-circle-outline","mdi-close-thick","mdi-content-copy","mdi-database-refresh","mdi-download","mdi-file-document-outline","mdi-file-excel-outline","mdi-file-music-outline","mdi-file-pdf-outline","mdi-filter-remove-outline","mdi-flip-vertical","mdi-folder","mdi-folder-open","mdi-help-circle","mdi-help-circle-outline","mdi-history","mdi-information","mdi-information-outline","mdi-link","mdi-link-variant","mdi-menu","mdi-microsoft-excel","mdi-minus","mdi-page-first","mdi-page-last","mdi-paperclip","mdi-pin-off-outline","mdi-pin-outline","mdi-playlist-plus","mdi-playlist-remove","mdi-plus","mdi-redo","mdi-refresh","mdi-shape-square-plus","mdi-sort-ascending","mdi-sort-descending","mdi-swap-horizontal","mdi-swap-vertical","mdi-sync","mdi-table-edit","mdi-table-refresh","mdi-undo"],r=Math.floor(Math.random()*i.length-1);return i[e??r]}renderItemCallbackWith2Rows(e){return`<div class="autocomplete-container-list">
    ...
    <div class="autocomplete-bottom-left">${e.itemNameTranslated}</div>
        ...
        </div>`}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}Hl=VD();sa=KD(Hl,0,"Example30",fg,sa);YD(Hl,1,sa);const eM=Object.freeze(Object.defineProperty({__proto__:null,get Example30(){return sa}},Symbol.toStringTag,{value:"Module"})),vg="example31",In=`<h2>
    ...
    <div>
      <div class="autocomplete-bottom-left">${e.itemNameTranslated}</div>
        ...
        <div>
          <div class="autocomplete-bottom-left">${e.itemNameTranslated}</div>
          <span class="autocomplete-bottom-right">Type: <b>${e.itemTypeName==="I"?"Item":e.itemTypeName==="C"?"PdCat":"Cat"}</b></span>
        </div>`}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}Kl=SM();ca=EM(Kl,0,"Example32",Mg,ca);TM(Kl,1,ca);const DM=Object.freeze(Object.defineProperty({__proto__:null,get Example32(){return ca}},Symbol.toStringTag,{value:"Module"})),Pg="example33",Fn=`<h2>
...
`,Ig=[],Gg={};let Cr;function MM(t){Cr||(Cr=E.define({name:Pg,template:Fn,dependencies:Ig,bindables:Gg})),t.register(Cr)}const PM=Object.freeze(Object.defineProperty({__proto__:null,bindables:Gg,default:Fn,dependencies:Ig,name:Pg,register:MM,template:Fn},Symbol.toStringTag,{value:"Module"}));var IM=Object.create,Ql=Object.defineProperty,GM=Object.getOwnPropertyDescriptor,FM=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Fg=t=>{throw TypeError(t)},Ag=(t,e,i)=>e in t?Ql(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,AM=(t,e)=>Ql(t,"name",{value:e,configurable:!0}),RM=t=>[,,,IM(null)],LM=["class","method","getter","setter","accessor","field","value","get","set"],Rg=t=>t!==void 0&&typeof t!="function"?Fg("Function expected"):t,zM=(t,e,i,r,a)=>({kind:LM[t],name:e,metadata:r,addInitializer:n=>i._?Fg("Already initialized"):a.push(Rg(n||null))}),NM=(t,e)=>Ag(e,FM("metadata"),t[3]),WM=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},BM=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&GM(a,i));AM(a,i);for(var p=r.length-1;p>=0;p--)u=zM(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Rg(l)&&(a=l);return NM(t,a),c&&Ql(a,i,c),m?s^4?n:c:a},Y=(t,e,i)=>Ag(t,typeof e!="symbol"?e+"":e,i),Lg,Zl;const jM=1e3;Lg=[T(PM)];class ua{constructor(){Y(this,"aureliaGrid"),Y(this,"columns",[]),Y(this,"gridOptions"),Y(this,"editCommandQueue",[]),Y(this,"dataset",[]),Y(this,"hideSubTitle",!1),Y(this,"serverApiDelay",500),Y(this,"showLazyLoading",!1),Y(this,"headerFormatter",(e,i,r,a)=>`<div class="header-tooltip-title">Custom Tooltip - Header</div>
...
`,Ng=[],Wg={};let wr;function HM(t){wr||(wr=E.define({name:zg,template:An,dependencies:Ng,bindables:Wg})),t.register(wr)}const UM=Object.freeze(Object.defineProperty({__proto__:null,bindables:Wg,default:An,dependencies:Ng,name:zg,register:HM,template:An},Symbol.toStringTag,{value:"Module"}));var AF=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function RF(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var qM=Object.create,Jl=Object.defineProperty,YM=Object.getOwnPropertyDescriptor,KM=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Bg=t=>{throw TypeError(t)},jg=(t,e,i)=>e in t?Jl(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,QM=(t,e)=>Jl(t,"name",{value:e,configurable:!0}),ZM=t=>[,,,qM(null)],JM=["class","method","getter","setter","accessor","field","value","get","set"],Vg=t=>t!==void 0&&typeof t!="function"?Bg("Function expected"):t,XM=(t,e,i,r,a)=>({kind:JM[t],name:e,metadata:r,addInitializer:n=>i._?Bg("Already initialized"):a.push(Vg(n||null))}),e2=(t,e)=>jg(e,KM("metadata"),t[3]),t2=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},i2=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&YM(a,i));QM(a,i);for(var p=r.length-1;p>=0;p--)u=XM(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Vg(l)&&(a=l);return e2(t,a),c&&Jl(a,i,c),m?s^4?n:c:a},H=(t,e,i)=>jg(t,typeof e!="symbol"?e+"":e,i),Hg,Xl;const a2=200,r2=(t,e,i)=>`<img src="https://flags.fmcdn.net/data/flags/mini/${i.substring(0,2).toLowerCase()}.png" width="20"/> ${i}`,n2=(t,e,i,r,a)=>{const n=a.priceChange>=0?"up":"down",l=new DocumentFragment,d=document.createElement("div");d.className=`d-inline-flex align-items-center text-${n==="up"?"success":"danger"}`;const u=document.createElement("span");return u.className=`mdi mdi-arrow-${n}`,d.appendChild(u),l.appendChild(d),i instanceof HTMLElement?d.appendChild(i):d.appendChild(document.createTextNode(i)),l},o2=(t,e,i)=>`<div class="d-inline-flex align-items-center"><span class="me-1 mdi font-16px mdi-${i==="Buy"?"plus":"minus"}-circle ${i==="Buy"?"text-info":"text-warning"}"></span> ${i}</div>`,l2=(t,e,i,r,a)=>{if(a.historic.length<2)return"";const n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.setAttributeNS(null,"width","135"),n.setAttributeNS(null,"height","30"),n.setAttributeNS(null,"stroke-width","2"),n.classList.add("sparkline"),Dv(n,a.historic,{cursorwidth:2,onmousemove:(d,u)=>{const m=d.target.closest("svg")?.nextElementSibling;m&&(m.hidden=!1,m.textContent=`$${(u.value*100/100).toFixed(2)}`,m.style.top=`${d.offsetY}px`,m.style.left=`${d.offsetX+20}px`)},onmouseout:d=>{const s=d.target.closest("svg")?.nextElementSibling;s&&(s.hidden=!0)}});const l=document.createElement("div");return l.appendChild(n),l.appendChild(D("div",{className:"trading-tooltip",hidden:!0})),l};Hg=[T(UM)];class ma{constructor(){H(this,"_darkMode",!1),H(this,"aureliaGrid"),H(this,"gridOptions"),H(this,"columns",[]),H(this,"dataset",[]),H(this,"hideSubTitle",!1),H(this,"isFullScreen",!1),H(this,"highlightDuration",150),H(this,"itemCount",200),H(this,"minChangePerCycle",0),H(this,"maxChangePerCycle",10),H(this,"refreshRate",75),H(this,"timer"),this.defineGrid()}attached(){this.getData(),setTimeout(()=>{this.startSimulation()},this.refreshRate)}detaching(){this.stopSimulation(),document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light"}defineGrid(){this.columns=[{id:"currency",name:"Currency",field:"currency",filterable:!0,sortable:!0,minWidth:65,width:65,formatter:r2,filter:{model:v.singleSelect,collection:[{label:"",value:""},{label:"CAD",value:"CAD"},{label:"USD",value:"USD"}]},grouping:{getter:"currency",formatter:e=>`Currency: <span style="color: var(--slick-primary-color); font-weight: bold;">${e.value}</span>  <span style="color: #659bff;">(${e.count} items)</span>`,aggregators:[new k.Sum("amount")],aggregateCollapsed:!0,collapsed:!1}},{id:"symbol",name:"Symbol",field:"symbol",filterable:!0,sortable:!0,minWidth:65,width:65},{id:"market",name:"Market",field:"market",filterable:!0,sortable:!0,minWidth:75,width:75,grouping:{getter:"market",formatter:e=>`Market: <span style="color: var(--slick-primary-color); font-weight: bold;">${e.value}</span>  <span style="color: #659bff;">(${e.count} items)</span>`,aggregators:[new k.Sum("amount")],aggregateCollapsed:!0,collapsed:!1}},{id:"company",name:"Company",field:"company",filterable:!0,sortable:!0,minWidth:80,width:130},{id:"trsnType",name:"Type",field:"trsnType",filterable:!0,sortable:!0,minWidth:60,width:60,formatter:o2,filter:{model:v.singleSelect,collection:[{label:"",value:""},{label:"Buy",value:"Buy"},{label:"Sell",value:"Sell"}]},grouping:{getter:"trsnType",formatter:e=>`Type: <span style="color: var(--slick-primary-color); font-weight: bold;">${e.value}</span>  <span style="color: #659bff;">(${e.count} items)</span>`,aggregators:[new k.Sum("amount")],aggregateCollapsed:!0,collapsed:!1}},{id:"priceChange",name:"Change",field:"priceChange",filterable:!0,sortable:!0,minWidth:80,width:80,filter:{model:v.compoundInputNumber},type:"number",formatter:f.multiple,params:{formatters:[f.dollar,n2],maxDecimal:2}},{id:"price",name:"Price",field:"price",filterable:!0,sortable:!0,minWidth:70,width:70,filter:{model:v.compoundInputNumber},type:"number",formatter:f.dollar,params:{maxDecimal:2}},{id:"quantity",name:"Quantity",field:"quantity",filterable:!0,sortable:!0,minWidth:70,width:70,filter:{model:v.compoundInputNumber},type:"number"},{id:"amount",name:"Amount",field:"amount",filterable:!0,sortable:!0,minWidth:70,width:60,filter:{model:v.compoundInputNumber},type:"number",formatter:f.dollar,params:{maxDecimal:2},groupTotalsFormatter:B.sumTotalsDollarBold},{id:"historic",name:"Price History",field:"historic",minWidth:100,width:150,maxWidth:150,formatter:l2},{id:"execution",name:"Execution Timestamp",field:"execution",filterable:!0,sortable:!0,minWidth:125,formatter:f.dateTimeIsoAmPm,exportWithFormatter:!0,type:"dateTimeIsoAM_PM",filter:{model:v.compoundDate}}],this.gridOptions={autoResize:{container:".trading-platform",autoHeight:!1,rightPadding:0,bottomPadding:10},formatterOptions:{displayNegativeNumberWithParentheses:!0,thousandSeparator:","},draggableGrouping:{dropPlaceHolderText:"Drop a column header here to group by any of these available columns: Currency, Market or Type",deleteIconCssClass:"mdi mdi-close color-danger",sortAscIconCssClass:"mdi mdi-arrow-up",sortDescIconCssClass:"mdi mdi-arrow-down"},enableDraggableGrouping:!0,createPreHeaderPanel:!0,darkMode:this._darkMode,showPreHeaderPanel:!0,preHeaderPanelHeight:40,enableCellNavigation:!0,enableFiltering:!0,cellHighlightCssClass:"changed"}}getData(){const e=[];for(let i=0;i<a2;i++){const r=Math.round(Math.random()*100),a=this.randomNumber(1,50),n=this.randomNumber(125,255),l=this.randomNumber(-25,35,!1),d=this.randomNumber(l,300),u=d<5?n:a,s=d*u,m=new Date;m.setHours(9,30,0);const o=Math.floor(Math.random()*10)%2?"CAD":"USD",g=dt.company.name();e[i]={id:i,currency:o,trsnType:Math.round(Math.random()*100)%2?"Buy":"Sell",company:g,symbol:o==="CAD"?g.substr(0,3).toUpperCase()+".TO":g.substr(0,4).toUpperCase(),market:o==="CAD"?"TSX":d>200?"Nasdaq":"S&P 500",duration:i%33===0?null:Math.random()*100+"",percentCompleteNumber:r,priceChange:l,price:d,quantity:u,amount:s,execution:m,historic:[d]}}this.dataset=e}startSimulation(){const e={},i=this.randomNumber(this.minChangePerCycle,this.maxChangePerCycle);for(let r=0;r<i;r++){const a=this.randomNumber(1,50),n=this.randomNumber(125,255),l=Math.round(Math.random()*(this.dataset.length-1)),d=this.randomNumber(-25,25,!1),u=Ov(this.dataset[l]),s={...this.dataset[l]};s.priceChange=d,s.price=s.price+d<0?0:s.price+d,s.quantity=s.price<5?n:a,s.amount=s.price*s.quantity,s.trsnType=Math.round(Math.random()*100)%2?"Buy":"Sell",s.execution=new Date,s.historic.push(s.price),s.historic=s.historic.slice(-20),e[l]||(e[l]={}),e[l].id="changed",this.renderCellHighlighting(s,this.findColumnById("priceChange"),d),(u.priceChange<0&&s.priceChange>0||u.priceChange>0&&s.priceChange<0)&&this.renderCellHighlighting(s,this.findColumnById("price"),d),this.aureliaGrid.dataView.updateItem(s.id,s)}this.timer=setTimeout(this.startSimulation.bind(this),this.refreshRate||0)}stopSimulation(){clearTimeout(this.timer)}findColumnById(e){return this.columns.find(i=>i?.field===e)}renderCellHighlighting(e,i,r){if(e&&i){const a=this.aureliaGrid.dataView.getRowByItem(e);if(a>=0){const n={[a]:{[i.id]:r>=0?"changed-gain":"changed-loss"}};this.aureliaGrid.slickGrid.setCellCssStyles(`highlight_${[i.id]}${a}`,n),setTimeout(()=>this.removeUnsavedStylingFromCell(e,i,a),this.highlightDuration)}}}removeUnsavedStylingFromCell(e,i,r){this.aureliaGrid.slickGrid.removeCellCssStyles(`highlight_${[i.id]}${r}`)}toggleFullScreen(){const e=document.querySelector(".trading-platform");e?.classList.contains("full-screen")?(e.classList.remove("full-screen"),this.isFullScreen=!1):e&&(e.classList.add("full-screen"),this.isFullScreen=!0),this.aureliaGrid.resizerService.resizeGrid()}toggleDarkMode(){this._darkMode=!this._darkMode,this.toggleBodyBackground(),this.aureliaGrid.slickGrid?.setOptions({darkMode:this._darkMode})}toggleBodyBackground(){this._darkMode?(document.querySelector(".panel-wm-content").classList.add("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="dark"):(document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light")}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}randomNumber(e,i,r=!0){const a=Math.random()*(i-e+1)+e;return r?Math.floor(a):a}}Xl=ZM();ma=i2(Xl,0,"Example34",Hg,ma);t2(Xl,1,ma);const s2=Object.freeze(Object.defineProperty({__proto__:null,get Example34(){return ma}},Symbol.toStringTag,{value:"Module"})),Ug="example35",Rn=`<h2>
...
`,lb=[],sb={};let $r;function z2(t){$r||($r=E.define({name:ob,template:zn,dependencies:lb,bindables:sb})),t.register($r)}const N2=Object.freeze(Object.defineProperty({__proto__:null,bindables:sb,default:zn,dependencies:lb,name:ob,register:z2,template:zn},Symbol.toStringTag,{value:"Module"}));var W2=Object.create,rs=Object.defineProperty,B2=Object.getOwnPropertyDescriptor,j2=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),db=t=>{throw TypeError(t)},cb=(t,e,i)=>e in t?rs(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,V2=(t,e)=>rs(t,"name",{value:e,configurable:!0}),H2=t=>[,,,W2(null)],U2=["class","method","getter","setter","accessor","field","value","get","set"],ub=t=>t!==void 0&&typeof t!="function"?db("Function expected"):t,q2=(t,e,i,r,a)=>({kind:U2[t],name:e,metadata:r,addInitializer:n=>i._?db("Already initialized"):a.push(ub(n||null))}),Y2=(t,e)=>cb(e,j2("metadata"),t[3]),K2=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},Q2=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&B2(a,i));V2(a,i);for(var p=r.length-1;p>=0;p--)u=q2(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,ub(l)&&(a=l);return Y2(t,a),c&&rs(a,i,c),m?s^4?n:c:a},Ke=(t,e,i)=>cb(t,typeof e!="symbol"?e+"":e,i),mb,ns;const Z2=100;mb=[T(N2)];class ga{constructor(){Ke(this,"_darkMode",!1),Ke(this,"aureliaGrid"),Ke(this,"gridOptions"),Ke(this,"columns",[]),Ke(this,"dataset",[]),Ke(this,"hideSubTitle",!1),Ke(this,"resizerPaused",!1),this.defineGrid()}attached(){this.dataset=this.loadData(Z2),this.updateAllTotals()}detaching(){document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light"}defineGrid(){const e=[];for(let i=0;i<10;i++)e.push({id:i,name:String.fromCharCode(65+i),field:String(i),type:"number",width:58,editor:{model:C.integer}});this.columns=e,this.gridOptions={autoEdit:!0,autoCommitEdit:!0,editable:!0,darkMode:this._darkMode,gridHeight:450,gridWidth:800,enableCellNavigation:!0,rowHeight:30,createFooterRow:!0,showFooterRow:!0,footerRowHeight:28}}loadData(e){const i=[];for(let r=0;r<e;r++){const a=i[r]={};a.id=r;for(let n=0;n<this.columns.length;n++)a[n]=Math.round(Math.random()*10)}return i}handleOnCellChange(e,i){this.updateTotal(i.cell)}handleOnColumnsReordered(){this.updateAllTotals()}toggleDarkMode(){this._darkMode=!this._darkMode,this.toggleBodyBackground(),this.aureliaGrid.slickGrid?.setOptions({darkMode:this._darkMode}),this.updateAllTotals()}toggleBodyBackground(){this._darkMode?(document.querySelector(".panel-wm-content").classList.add("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="dark"):(document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light")}updateAllTotals(){let e=this.aureliaGrid.slickGrid?.getColumns().length||0;for(;e--;)this.updateTotal(e)}updateTotal(e){const i=this.aureliaGrid.slickGrid?.getColumns()[e].id;let r=0,a=this.dataset.length;for(;a--;)r+=parseInt(this.dataset[a][i],10)||0;const n=this.aureliaGrid.slickGrid?.getFooterRowColumn(i);n&&(n.textContent=`Sum: ${r}`)}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}ns=H2();ga=Q2(ns,0,"Example37",mb,ga);K2(ns,1,ga);const J2=Object.freeze(Object.defineProperty({__proto__:null,get Example37(){return ga}},Symbol.toStringTag,{value:"Module"})),pb="example38",Nn=`<div class="demo38">
  <h2>
...
`,Sb=[],Cb={};let Or;function hP(t){Or||(Or=E.define({name:yb,template:Wn,dependencies:Sb,bindables:Cb})),t.register(Or)}const gP=Object.freeze(Object.defineProperty({__proto__:null,bindables:Cb,default:Wn,dependencies:Sb,name:yb,register:hP,template:Wn},Symbol.toStringTag,{value:"Module"}));var bP=Object.create,ss=Object.defineProperty,fP=Object.getOwnPropertyDescriptor,vP=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),wb=t=>{throw TypeError(t)},xb=(t,e,i)=>e in t?ss(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,_P=(t,e)=>ss(t,"name",{value:e,configurable:!0}),yP=t=>[,,,bP(null)],SP=["class","method","getter","setter","accessor","field","value","get","set"],Tb=t=>t!==void 0&&typeof t!="function"?wb("Function expected"):t,CP=(t,e,i,r,a)=>({kind:SP[t],name:e,metadata:r,addInitializer:n=>i._?wb("Already initialized"):a.push(Tb(n||null))}),wP=(t,e)=>xb(e,vP("metadata"),t[3]),xP=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},TP=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&fP(a,i));_P(a,i);for(var p=r.length-1;p>=0;p--)u=CP(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Tb(l)&&(a=l);return wP(t,a),c&&ss(a,i,c),m?s^4?n:c:a},U=(t,e,i)=>xb(t,typeof e!="symbol"?e+"":e,i),Eb,ds;const Oi="users",EP=250;function Dr(t){return t.replace(/^"/,"").replace(/"$/,"").toLowerCase()}Eb=[T(gP)];class fa{constructor(e=M(_e(ye)),i=M(Se)){this.http=e,this.i18n=i,U(this,"aureliaGrid"),U(this,"backendService"),U(this,"columns"),U(this,"gridOptions"),U(this,"dataset",[]),U(this,"metrics"),U(this,"tagDataClass",""),U(this,"graphqlQuery","..."),U(this,"hideSubTitle",!1),U(this,"processing",!1),U(this,"selectedLanguage",""),U(this,"status",{text:"processing...",class:"alert alert-danger"}),U(this,"serverWaitDelay",EP),this.backendService=new no;const r="en";this.i18n.setLocale(r),this.selectedLanguage=r,this.initializeGrid()}aureliaGridReady(e){this.aureliaGrid=e}initializeGrid(){this.columns=[{id:"name",field:"name",nameKey:"NAME",width:60,sortable:!0,filterable:!0,filter:{model:v.compoundInput}},{id:"gender",field:"gender",nameKey:"GENDER",filterable:!0,sortable:!0,width:60,filter:{model:v.singleSelect,collection:[{value:"",label:""},{value:"male",labelKey:"MALE"},{value:"female",labelKey:"FEMALE"}]}},{id:"company",field:"company",nameKey:"COMPANY",width:60,sortable:!0,filterable:!0,filter:{model:v.multipleSelect,customStructure:{label:"company",value:"company"},collectionSortBy:{property:"company",sortDesc:!1},collectionAsync:this.http.fetch(ft).then(e=>e.json()),options:{filter:!0}}}],this.gridOptions={enableAutoResize:!0,autoResize:{container:"#demo-container",rightPadding:10},enableAutoTooltip:!0,autoTooltipOptions:{enableForHeaderCells:!0},enableTranslate:!0,i18n:this.i18n,enableFiltering:!0,enableCellNavigation:!0,multiColumnSort:!1,gridMenu:{resizeOnShowHeaderRow:!0},backendServiceApi:{disableInternalPostProcess:!0,service:this.backendService,options:{datasetName:Oi,addLocaleIntoQuery:!0,extraQueryArguments:[{field:"userId",value:123}],infiniteScroll:{fetchSize:30}},preProcess:()=>this.displaySpinner(!0),process:e=>this.getCustomerApiCall(e),postProcess:e=>{this.metrics={endTime:new Date,totalItemCount:e.data[Oi].totalCount||0},this.displaySpinner(!1),this.getCustomerCallback(e)}}}}clearAllFiltersAndSorts(){this.aureliaGrid?.gridService&&this.aureliaGrid.gridService.clearAllFiltersAndSorts()}displaySpinner(e){this.processing=e,this.status=e?{text:"processing...",class:"alert alert-danger"}:{text:"finished",class:"alert alert-success"}}getCustomerCallback(e){const{nodes:i,totalCount:r}=e.data[Oi];this.aureliaGrid&&(this.metrics.totalItemCount=r,e.infiniteScrollBottomHit?this.aureliaGrid.dataView?.addItems(i):(this.aureliaGrid.slickGrid?.scrollTo(0),this.dataset=i,this.metrics.itemCount=i.length))}getCustomerApiCall(e){return this.getCustomerDataApiMock(e)}getCustomerDataApiMock(e){return new Promise(i=>{let r=0,a=0,n="",l="";this.http.fetch(ft).then(d=>d.json()).then(d=>{let u=d;if(e.includes("first:")&&(r=+(e.match(/first:([0-9]+),/)||[])[1]),e.includes("offset:")&&(a=+(e.match(/offset:([0-9]+),/)||[])[1]),e.includes("orderBy:")){const[c,p,_]=/orderBy:\[{field:([a-zA-Z/]+),direction:(ASC|DESC)}\]/gi.exec(e)||[];n=p||"",l=_||""}if(e.includes("orderBy:")){const[c,p,_]=/orderBy:\[{field:([a-zA-Z/]+),direction:(ASC|DESC)}\]/gi.exec(e)||[];n=p||"",l=_||""}if(e.includes("filterBy:")){const c=/{field:(\w+),operator:(\w+),value:([0-9a-z',"\s]*)}/gi;let p;for(;(p=c.exec(e))!==null;){const _=p[1]||"",w=p[2]||"",x=p[3]||"";let[b,y]=x.split(",");_&&w&&x!==""&&(u=u.filter(h=>{const S=h[_];switch(b=Dr(b),y=Dr(y||""),w){case"EQ":return S.toLowerCase()===b;case"NE":return S.toLowerCase()!==b;case"LE":return S.toLowerCase()<=b;case"LT":return S.toLowerCase()<b;case"GT":return S.toLowerCase()>b;case"GE":return S.toLowerCase()>=b;case"EndsWith":return S.toLowerCase().endsWith(b);case"StartsWith":return S.toLowerCase().startsWith(b);case"Starts+Ends":return S.toLowerCase().startsWith(b)&&S.toLowerCase().endsWith(y);case"Contains":return S.toLowerCase().includes(b);case"Not_Contains":return!S.toLowerCase().includes(b);case"IN":const hv=x.toLocaleLowerCase().split(",");for(const gv of hv)if(S.toLocaleLowerCase()===Dr(gv))return!0;break}}))}}let s=a;s>u.length&&(e=e.replace(`offset:${s}`,""),s=0);const m=c=>n?c[n]:c;switch(l.toUpperCase()){case"ASC":u=u.sort((c,p)=>m(c).localeCompare(m(p)));break;case"DESC":u=u.sort((c,p)=>m(p).localeCompare(m(c)));break}const o=u.slice(s,s+r),g={data:{[Oi]:{nodes:o,totalCount:u.length}}};setTimeout(()=>{this.graphqlQuery=this.gridOptions.backendServiceApi.service.buildQuery(),i(g)},this.serverWaitDelay)})})}refreshMetrics(e){e?.current>=0&&(this.metrics.itemCount=this.aureliaGrid.dataView?.getFilteredItemCount()||0,this.tagDataClass=this.metrics.itemCount===this.metrics.totalItemCount?"fully-loaded":"partial-load")}async switchLanguage(){const e=this.selectedLanguage==="en"?"fr":"en";await this.i18n.setLocale(e),this.selectedLanguage=e}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}ds=yP();fa=TP(ds,0,"Example39",Eb,fa);xP(ds,1,fa);const $P=Object.freeze(Object.defineProperty({__proto__:null,get Example39(){return fa}},Symbol.toStringTag,{value:"Module"})),$b="example40",Bn=`<div class="demo40">
  <h2>
...
`,Bb=[],jb={};let Ir;function eI(t){Ir||(Ir=E.define({name:Wb,template:Vn,dependencies:Bb,bindables:jb})),t.register(Ir)}const tI=Object.freeze(Object.defineProperty({__proto__:null,bindables:jb,default:Vn,dependencies:Bb,name:Wb,register:eI,template:Vn},Symbol.toStringTag,{value:"Module"}));var iI=Object.create,hs=Object.defineProperty,aI=Object.getOwnPropertyDescriptor,rI=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),vi=t=>{throw TypeError(t)},Vb=(t,e,i)=>e in t?hs(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Dd=(t,e)=>hs(t,"name",{value:e,configurable:!0}),nI=t=>[,,,iI(null)],Hb=["class","method","getter","setter","accessor","field","value","get","set"],Yt=t=>t!==void 0&&typeof t!="function"?vi("Function expected"):t,oI=(t,e,i,r,a)=>({kind:Hb[t],name:e,metadata:r,addInitializer:n=>i._?vi("Already initialized"):a.push(Yt(n||null))}),lI=(t,e)=>Vb(e,rI("metadata"),t[3]),Hn=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Ub=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Hb[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&aI(o<4?a:{get[i](){return Md(this,n)},set[i](h){return Pd(this,n,h)}},i));o?c&&o<4&&Dd(n,(o>2?"set ":o>1?"get ":"")+i):Dd(a,i);for(var y=r.length-1;y>=0;y--)s=oI(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>sI(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?Md:dI)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Pd(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Yt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?vi("Object expected"):(Yt(l=d.get)&&(b.get=l),Yt(l=d.set)&&(b.set=l),Yt(l=d.init)&&w.unshift(l));return o||lI(t,a),b&&hs(a,i,b),c?o^4?n:b:a},De=(t,e,i)=>Vb(t,typeof e!="symbol"?e+"":e,i),gs=(t,e,i)=>e.has(t)||vi("Cannot "+i),sI=(t,e)=>Object(e)!==e?vi('Cannot use the "in" operator on this value'):t.has(e),Md=(t,e,i)=>(gs(t,e,"read from private field"),i?i.call(t):e.get(t)),Pd=(t,e,i,r)=>(gs(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),dI=(t,e,i)=>(gs(t,e,"access private method"),i),qb,Yb,St;const cI=5e3;function It(t,e){return Math.floor(Math.random()*(e-t+1)+t)}Yb=[T(tI)],qb=[O()];class ai{constructor(){De(this,"pageSize",Hn(St,8,this,50)),Hn(St,11,this),De(this,"aureliaGrid"),De(this,"columns",[]),De(this,"gridContainerElm"),De(this,"gridOptions"),De(this,"dataset",[]),De(this,"paginationPosition","top"),De(this,"hideSubTitle",!1),De(this,"paginationOptions"),this.defineGrid()}attached(){this.dataset=this.loadData(cI)}aureliaGridReady(e){this.aureliaGrid=e}defineGrid(){this.columns=[{id:"title",name:"Title",field:"id",minWidth:100,sortable:!0,filterable:!0,formatter:(e,i,r)=>`Task ${r}`,params:{useFormatterOuputToFilter:!0}},{id:"description",name:"Description",field:"description",filterable:!0,sortable:!0,minWidth:80},{id:"percentComplete",name:"% Complete",field:"percentComplete",minWidth:120,sortable:!0,customTooltip:{position:"center"},formatter:f.progressBar,type:"number",filterable:!0,filter:{model:v.sliderRange,maxValue:100,operator:"RangeInclusive",options:{hideSliderNumbers:!1,min:0,step:5}}},{id:"start",name:"Start",field:"start",formatter:f.dateIso,sortable:!0,minWidth:75,width:100,exportWithFormatter:!0,type:"date",filterable:!0,filter:{model:v.compoundDate}},{id:"finish",name:"Finish",field:"finish",formatter:f.dateIso,sortable:!0,minWidth:75,width:120,exportWithFormatter:!0,type:"date",filterable:!0,filter:{model:v.dateRange}},{id:"duration",field:"duration",name:"Duration",maxWidth:90,type:"number",sortable:!0,filterable:!0,filter:{model:v.input,operator:"RangeExclusive"}},{id:"completed",name:"Completed",field:"completed",minWidth:85,maxWidth:90,formatter:f.checkmarkMaterial,exportWithFormatter:!0,filterable:!0,filter:{collection:[{value:"",label:""},{value:!0,label:"True"},{value:!1,label:"False"}],model:v.singleSelect,options:{autoAdjustDropHeight:!0}}}],this.gridOptions={autoResize:{container:"#demo-container",bottomPadding:this.paginationPosition==="top"?-1:38},enableExcelCopyBuffer:!0,enableFiltering:!0,customPaginationComponent:ht,enablePagination:!0,pagination:{pageSize:this.pageSize},rowHeight:40}}loadData(e){const i=[];for(let r=0,a=e;r<a;r++){const n=It(0,365),l=It(new Date().getFullYear(),new Date().getFullYear()+1),d=It(0,12),u=It(10,28),s=It(0,100);i.push({id:r,title:"Task "+r,description:r%5?"desc "+r:null,duration:n,percentComplete:s,percentCompleteNumber:s,start:r%4?null:new Date(l,d,u),finish:new Date(l,d,u),completed:s===100})}return i}pageSizeChanged(e){this.aureliaGrid.paginationService?.changeItemPerPage(e)}togglePaginationPosition(){const e=document.querySelector(`#${this.aureliaGrid.slickGrid.getOptions().gridContainerId||""}`);this.paginationPosition=this.paginationPosition==="top"?"bottom":"top",this.aureliaGrid.paginationComponent?.disposeElement(),this.aureliaGrid.paginationComponent?.renderPagination(e,this.paginationPosition)}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}St=nI();Ub(St,5,"pageSize",qb,ai);ai=Ub(St,0,"Example42",Yb,ai);Hn(St,1,ai);const uI=Object.freeze(Object.defineProperty({__proto__:null,get Example42(){return ai}},Symbol.toStringTag,{value:"Module"})),Kb="example43",Un=`<h2>
...
`,$f=[],kf={};let Lr;function sG(t){Lr||(Lr=E.define({name:Ef,template:Zn,dependencies:$f,bindables:kf})),t.register(Lr)}const dG=Object.freeze(Object.defineProperty({__proto__:null,bindables:kf,default:Zn,dependencies:$f,name:Ef,register:sG,template:Zn},Symbol.toStringTag,{value:"Module"}));var cG=Object.create,Ts=Object.defineProperty,uG=Object.getOwnPropertyDescriptor,mG=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Si=t=>{throw TypeError(t)},Of=(t,e,i)=>e in t?Ts(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,zd=(t,e)=>Ts(t,"name",{value:e,configurable:!0}),pG=t=>[,,,cG(null)],Df=["class","method","getter","setter","accessor","field","value","get","set"],Jt=t=>t!==void 0&&typeof t!="function"?Si("Function expected"):t,hG=(t,e,i,r,a)=>({kind:Df[t],name:e,metadata:r,addInitializer:n=>i._?Si("Already initialized"):a.push(Jt(n||null))}),gG=(t,e)=>Of(e,mG("metadata"),t[3]),Xt=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)e&1?n[a].call(i):r=n[a].call(i,r);return r},Es=(t,e,i,r,a,n)=>{var l,d,u,s,m,o=e&7,g=!!(e&8),c=!!(e&16),p=o>3?t.length+1:o?g?1:2:0,_=Df[o+5],w=o>3&&(t[p-1]=[]),x=t[p]||(t[p]=[]),b=o&&(!c&&!g&&(a=a.prototype),o<5&&(o>3||!c)&&uG(o<4?a:{get[i](){return Nd(this,n)},set[i](h){return Wd(this,n,h)}},i));o?c&&o<4&&zd(n,(o>2?"set ":o>1?"get ":"")+i):zd(a,i);for(var y=r.length-1;y>=0;y--)s=hG(o,i,u={},t[3],x),o&&(s.static=g,s.private=c,m=s.access={has:c?h=>bG(a,h):h=>i in h},o^3&&(m.get=c?h=>(o^1?Nd:fG)(h,a,o^4?n:b.get):h=>h[i]),o>2&&(m.set=c?(h,S)=>Wd(h,a,S,o^4?n:b.set):(h,S)=>h[i]=S)),d=(0,r[y])(o?o<4?c?n:b[_]:o>4?void 0:{get:b.get,set:b.set}:a,s),u._=1,o^4||d===void 0?Jt(d)&&(o>4?w.unshift(d):o?c?n=d:b[_]=d:a=d):typeof d!="object"||d===null?Si("Object expected"):(Jt(l=d.get)&&(b.get=l),Jt(l=d.set)&&(b.set=l),Jt(l=d.init)&&w.unshift(l));return o||gG(t,a),b&&Ts(a,i,b),c?o^4?n:b:a},ie=(t,e,i)=>Of(t,typeof e!="symbol"?e+"":e,i),$s=(t,e,i)=>e.has(t)||Si("Cannot "+i),bG=(t,e)=>Object(e)!==e?Si('Cannot use the "in" operator on this value'):t.has(e),Nd=(t,e,i)=>($s(t,e,"read from private field"),i?i.call(t):e.get(t)),Wd=(t,e,i,r)=>($s(t,e,"write to private field"),r?r.call(t,i):e.set(t,i),i),fG=(t,e,i)=>($s(t,e,"access private method"),i),Mf,Pf,If,Fe;const vG=250,_G=1200;If=[T(dG)],Pf=[O],Mf=[O];class xt{constructor(){ie(this,"_darkMode",!1),ie(this,"detailViewRowCount",Xt(Fe,8,this,9)),Xt(Fe,11,this),ie(this,"serverWaitDelay",Xt(Fe,12,this,vG)),Xt(Fe,15,this),ie(this,"aureliaGrid"),ie(this,"dataviewObj"),ie(this,"gridObj"),ie(this,"gridOptions"),ie(this,"columns",[]),ie(this,"dataset",[]),ie(this,"hideSubTitle",!1),ie(this,"message",""),this.defineGrid()}get rowDetailInstance(){return this.aureliaGrid?.extensionService.getExtensionInstanceByName(Mv.rowDetailView)}attached(){this.getData()}detaching(){document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light"}aureliaGridReady(e){this.aureliaGrid=e,this.dataviewObj=e.dataView,this.gridObj=e.slickGrid,this.groupByDuration()}defineGrid(){this.columns=[{id:"title",name:"Title",field:"title",sortable:!0,width:70,filterable:!0,editor:{model:C.text}},{id:"duration",name:"Duration (days)",field:"duration",sortable:!0,type:"number",minWidth:90,filterable:!0},{id:"%",name:"% Complete",field:"percentComplete",minWidth:200,width:250,resizable:!1,filterable:!0,sortable:!0,type:"number",formatter:f.percentCompleteBar,groupTotalsFormatter:B.avgTotalsPercentage,params:{groupFormatterPrefix:"<i>Avg</i>: "}},{id:"start",name:"Start",field:"start",formatter:f.dateIso,sortable:!0,type:"date",minWidth:90,exportWithFormatter:!0,filterable:!0,filter:{model:v.compoundDate}},{id:"finish",name:"Finish",field:"finish",formatter:f.dateIso,sortable:!0,type:"date",minWidth:90,exportWithFormatter:!0,filterable:!0,filter:{model:v.compoundDate}},{id:"cost",name:"Cost",field:"cost",minWidth:70,width:80,sortable:!0,filterable:!0,filter:{model:v.compoundInputNumber},type:"number",formatter:f.dollar,groupTotalsFormatter:B.sumTotalsDollarBold},{id:"effort-driven",name:"Effort Driven",field:"effortDriven",minWidth:100,formatter:f.checkmarkMaterial,type:"boolean",filterable:!0,sortable:!0,filter:{collection:[{value:"",label:""},{value:!0,label:"True"},{value:!1,label:"False"}],model:v.singleSelect}}],this.gridOptions={autoResize:{container:"#demo-container",rightPadding:10},enableFiltering:!0,enableGrouping:!0,enableRowDetailView:!0,rowTopOffsetRenderType:"top",darkMode:this._darkMode,externalResources:[oo],rowDetailView:{process:e=>this.simulateServerAsyncCall(e),loadOnce:!0,singleRowExpand:!1,panelRows:this.detailViewRowCount,preloadViewModel:mt,viewModel:ve,parentRef:this},selectionOptions:{selectActiveRow:!0}}}getData(){const e=[];for(let i=0;i<_G;i++){const r=2e3+Math.floor(Math.random()*10),a=Math.floor(Math.random()*11),n=Math.floor(Math.random()*29),l=Math.round(Math.random()*100),d=Math.round(Math.random()*1e4)/100;e[i]={id:i,title:"Task "+i,duration:Math.floor(Math.random()*100),percentComplete:l,start:new Date(r,a,n),finish:new Date(r,a+1,n),cost:i%3?d:-d,effortDriven:i%5===0}}this.dataset=e}changeDetailViewRowCount(){const e=this.rowDetailInstance.getOptions();e&&e.panelRows&&(e.panelRows=this.detailViewRowCount,this.rowDetailInstance.setOptions(e))}closeAllRowDetail(){this.rowDetailInstance.collapseAll()}clearGrouping(){this.dataviewObj.setGrouping([])}collapseAllGroups(){this.dataviewObj.collapseAllGroups()}expandAllGroups(){this.dataviewObj.expandAllGroups()}groupByDuration(){this.aureliaGrid.filterService.setSortColumnIcons([{columnId:"duration",sortAsc:!0}]),this.dataviewObj.setGrouping({getter:"duration",formatter:e=>`Duration: ${e.value} <span style="color:green">(${e.count} items)</span>`,comparer:(e,i)=>ne.numeric(e.value,i.value,ni.asc),aggregators:[new k.Avg("percentComplete"),new k.Sum("cost")],aggregateCollapsed:!1,lazyTotalsCalculation:!0}),this.gridObj.invalidate()}groupByDurationEffortDriven(){const e=[{columnId:"duration",sortAsc:!0},{columnId:"effortDriven",sortAsc:!0}];this.aureliaGrid.filterService.setSortColumnIcons(e),this.dataviewObj.setGrouping([{getter:"duration",formatter:i=>`Duration: ${i.value} <span style="color:green">(${i.count} items)</span>`,aggregators:[new k.Sum("duration"),new k.Sum("cost")],aggregateCollapsed:!0,lazyTotalsCalculation:!0},{getter:"effortDriven",formatter:i=>`Effort-Driven: ${i.value?"True":"False"} <span style="color:green">(${i.count} items)</span>`,aggregators:[new k.Avg("percentComplete"),new k.Sum("cost")],collapsed:!0,lazyTotalsCalculation:!0}]),this.gridObj.invalidate()}simulateServerAsyncCall(e){const i=["John Doe","Jane Doe","Chuck Norris","Bumblebee","Jackie Chan","Elvis Presley","Bob Marley","Mohammed Ali","Bruce Lee","Rocky Balboa"];return new Promise(r=>{setTimeout(()=>{const a=e;a.assignee=i[this.randomNumber(0,9)]||"",a.reporter=i[this.randomNumber(0,9)]||"",r(a)},this.serverWaitDelay)})}toggleDarkMode(){this._darkMode=!this._darkMode,this.toggleBodyBackground(),this.aureliaGrid.slickGrid?.setOptions({darkMode:this._darkMode}),this.closeAllRowDetail()}toggleBodyBackground(){this._darkMode?(document.querySelector(".panel-wm-content").classList.add("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="dark"):(document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light")}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}randomNumber(e,i){return Math.floor(Math.random()*(i-e+1)+e)}}Fe=pG();Es(Fe,5,"detailViewRowCount",Pf,xt);Es(Fe,5,"serverWaitDelay",Mf,xt);xt=Es(Fe,0,"Example47",If,xt);Xt(Fe,1,xt);const yG=Object.freeze(Object.defineProperty({__proto__:null,get Example47(){return xt}},Symbol.toStringTag,{value:"Module"})),Gf="example48",Jn=`<h2>
...
`,Bf=[],jf={};let Nr;function GG(t){Nr||(Nr=E.define({name:Wf,template:Xn,dependencies:Bf,bindables:jf})),t.register(Nr)}const FG=Object.freeze(Object.defineProperty({__proto__:null,bindables:jf,default:Xn,dependencies:Bf,name:Wf,register:GG,template:Xn},Symbol.toStringTag,{value:"Module"}));var AG=Object.create,Ds=Object.defineProperty,RG=Object.getOwnPropertyDescriptor,LG=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),Vf=t=>{throw TypeError(t)},Hf=(t,e,i)=>e in t?Ds(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,zG=(t,e)=>Ds(t,"name",{value:e,configurable:!0}),NG=t=>[,,,AG(null)],WG=["class","method","getter","setter","accessor","field","value","get","set"],Uf=t=>t!==void 0&&typeof t!="function"?Vf("Function expected"):t,BG=(t,e,i,r,a)=>({kind:WG[t],name:e,metadata:r,addInitializer:n=>i._?Vf("Already initialized"):a.push(Uf(n||null))}),jG=(t,e)=>Hf(e,LG("metadata"),t[3]),VG=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},HG=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&RG(a,i));zG(a,i);for(var p=r.length-1;p>=0;p--)u=BG(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,Uf(l)&&(a=l);return jG(t,a),c&&Ds(a,i,c),m?s^4?n:c:a},st=(t,e,i)=>Hf(t,typeof e!="symbol"?e+"":e,i),qf,Ms;const jd=100;qf=[T(FG)];class wa{constructor(){st(this,"_darkMode",!1),st(this,"aureliaGrid"),st(this,"columns",[]),st(this,"gridOptions"),st(this,"dataset"),st(this,"hideSubTitle",!1),this.defineGrid()}attached(){this.dataset=this.getData(jd)}detaching(){document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light"}aureliaGridReady(e){this.aureliaGrid=e}defineGrid(){this.columns=[{id:"selector",name:"",field:"num",width:30}];for(let e=0;e<jd;e++)this.columns.push({id:e,name:e<26?String.fromCharCode(65+e%26):String.fromCharCode(65+Math.floor(e/26)-1)+String.fromCharCode(65+e%26),field:String(e),minWidth:60,width:60,editor:{model:C.text}});this.gridOptions={autoResize:{container:"#demo-container",rightPadding:10},enableCellNavigation:!0,autoEdit:!0,autoCommitEdit:!0,darkMode:this._darkMode,editable:!0,headerRowHeight:35,editorNavigateOnArrows:!0,enableSelection:!0,selectionOptions:{rowSelectColumnIds:["selector"],selectActiveRow:!0,selectionType:"mixed"},enableExcelCopyBuffer:!0,excelCopyBufferOptions:{copyActiveEditorCell:!0,removeDoubleQuotesOnPaste:!0,replaceNewlinesWith:" "}}}copyDraggedCellRange(e){const i=it.verticalTargetRange(e.prevSelectedRange,e.selectedRange),r=it.horizontalTargetRange(e.prevSelectedRange,e.selectedRange),a=it.cornerTargetRange(e.prevSelectedRange,e.selectedRange);i&&it.copyCellsToTargetRange(e.prevSelectedRange,i,e.grid),r&&it.copyCellsToTargetRange(e.prevSelectedRange,r,e.grid),a&&it.copyCellsToTargetRange(e.prevSelectedRange,a,e.grid)}getData(e){const i=[];for(let r=0;r<e;r++){const a=i[r]={};a.id=r,a.num=r}return i}toggleDarkMode(){this._darkMode=!this._darkMode,this.toggleBodyBackground(),this.aureliaGrid.slickGrid?.setOptions({darkMode:this._darkMode})}toggleBodyBackground(){this._darkMode?(document.querySelector(".panel-wm-content").classList.add("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="dark"):(document.querySelector(".panel-wm-content").classList.remove("dark-mode"),document.querySelector("#demo-container").dataset.bsTheme="light")}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;const e=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[e]("hidden"),this.aureliaGrid.resizerService.resizeGrid(0)}}Ms=NG();wa=HG(Ms,0,"Example49",qf,wa);VG(Ms,1,wa);const UG=Object.freeze(Object.defineProperty({__proto__:null,get Example49(){return wa}},Symbol.toStringTag,{value:"Module"})),Yf="example50",eo=`<h2>
...
`,iv=[],av={};let Br;function oF(t){Br||(Br=E.define({name:tv,template:to,dependencies:iv,bindables:av})),t.register(Br)}const lF=Object.freeze(Object.defineProperty({__proto__:null,bindables:av,default:to,dependencies:iv,name:tv,register:oF,template:to},Symbol.toStringTag,{value:"Module"}));var sF=Object.create,Gs=Object.defineProperty,dF=Object.getOwnPropertyDescriptor,cF=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),rv=t=>{throw TypeError(t)},nv=(t,e,i)=>e in t?Gs(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,uF=(t,e)=>Gs(t,"name",{value:e,configurable:!0}),mF=t=>[,,,sF(null)],pF=["class","method","getter","setter","accessor","field","value","get","set"],ov=t=>t!==void 0&&typeof t!="function"?rv("Function expected"):t,hF=(t,e,i,r,a)=>({kind:pF[t],name:e,metadata:r,addInitializer:n=>i._?rv("Already initialized"):a.push(ov(n||null))}),gF=(t,e)=>nv(e,cF("metadata"),t[3]),bF=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},fF=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&dF(a,i));uF(a,i);for(var p=r.length-1;p>=0;p--)u=hF(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,ov(l)&&(a=l);return gF(t,a),c&&Gs(a,i,c),m?s^4?n:c:a},Gt=(t,e,i)=>nv(t,typeof e!="symbol"?e+"":e,i),lv,Fs;const vF=2e3;lv=[T(lF)];class Ta{constructor(){Gt(this,"aureliaGrid"),Gt(this,"columns",[]),Gt(this,"gridOptions"),Gt(this,"dataset"),Gt(this,"hideSubTitle",!1),this.defineGrid()}attached(){this.dataset=this.loadData(vF)}aureliaGridReady(e){this.aureliaGrid=e}defineGrid(){this.columns=[{id:"title",name:"Title",field:"title",sortable:!0,filterable:!0,minWidth:100,header:{menu:{commandItems:[{command:"sort-asc",title:"Sort Ascending",positionOrder:50,slotRenderer:e=>`
                  <div class="menu-item">
...
`,dv=[],cv={};let jr;function yF(t){jr||(jr=E.define({name:sv,template:io,dependencies:dv,bindables:cv})),t.register(jr)}const SF=Object.freeze(Object.defineProperty({__proto__:null,bindables:cv,default:io,dependencies:dv,name:sv,register:yF,template:io},Symbol.toStringTag,{value:"Module"}));var CF=Object.create,As=Object.defineProperty,wF=Object.getOwnPropertyDescriptor,xF=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),uv=t=>{throw TypeError(t)},TF=(t,e,i)=>e in t?As(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,EF=(t,e)=>As(t,"name",{value:e,configurable:!0}),$F=t=>[,,,CF(null)],kF=["class","method","getter","setter","accessor","field","value","get","set"],mv=t=>t!==void 0&&typeof t!="function"?uv("Function expected"):t,OF=(t,e,i,r,a)=>({kind:kF[t],name:e,metadata:r,addInitializer:n=>i._?uv("Already initialized"):a.push(mv(n||null))}),DF=(t,e)=>TF(e,xF("metadata"),t[3]),MF=(t,e,i,r)=>{for(var a=0,n=t[e>>1],l=n&&n.length;a<l;a++)n[a].call(i);return r},PF=(t,e,i,r,a,n)=>{var l,d,u,s=e&7,m=!1,o=0,g=t[o]||(t[o]=[]),c=s&&(a=a.prototype,s<5&&(s>3||!m)&&wF(a,i));EF(a,i);for(var p=r.length-1;p>=0;p--)u=OF(s,i,d={},t[3],g),l=(0,r[p])(a,u),d._=1,mv(l)&&(a=l);return DF(t,a),c&&As(a,i,c),m?s^4?n:c:a},pv,Rs;pv=[T(SF)];class Ea{constructor(e=M(Pv)){this.aurelia=e,console.log(e)}}Rs=$F();Ea=PF(Rs,0,"HomePage",pv,Ea);MF(Rs,1,Ea);const IF=Object.freeze(Object.defineProperty({__proto__:null,get HomePage(){return Ea}},Symbol.toStringTag,{value:"Module"}));export{$ as _,AF as c,RF as g};
